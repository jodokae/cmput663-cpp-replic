...
mode=040000;
break;
case osfile_IS_IMAGE:
mode=0140000;
break;
default:
return riscos_error("Not found");
}
...
PyStructSequence_SET_ITEM(v, 1, PyInt_FromLong((long) 0));
PyStructSequence_SET_ITEM(v, 2, PyInt_FromLong((long) 0));
PyStructSequence_SET_ITEM(v, 3, PyInt_FromLong((long) 0));
PyStructSequence_SET_ITEM(v, 4, PyInt_FromLong((long) 0));
PyStructSequence_SET_ITEM(v, 5, PyInt_FromLong((long) 0));
PyStructSequence_SET_ITEM(v, 6,
PyInt_FromLong((long) len));
PyStructSequence_SET_ITEM(v, 7, PyInt_FromLong((long) t));
PyStructSequence_SET_ITEM(v, 8, PyInt_FromLong((long) t));
PyStructSequence_SET_ITEM(v, 9, PyInt_FromLong((long) t));
PyStructSequence_SET_ITEM(v, 10,
PyInt_FromLong((long) ft));
PyStructSequence_SET_ITEM(v, 11,
PyInt_FromLong((long) at));
