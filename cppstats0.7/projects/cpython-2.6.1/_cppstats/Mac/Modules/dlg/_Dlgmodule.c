...
if (PyInt_Check(v)) {
*p_itself = (DialogPtr)PyInt_AsLong(v);
return 1;
}
if (!DlgObj_Check(v)) {
...
SInt16 strtSel;
SInt16 endSel;
#if !defined(SelectDialogItemText)
...
#if !defined(SetDialogDefaultItem)
...
OSErr _err;
DialogItemIndex newItem;
#if !defined(SetDialogCancelItem)
...
OSErr _err;
Boolean tracks;
#if !defined(SetDialogTracksCursor)
...
#if !defined(GetDialogItemAsControl)
...
SInt16 ditlID;
DITLMethod method;
#if !defined(AppendDialogItemList)
...
OSStatus _err;
EventMask inMask;
#if !defined(SetModalDialogEventMask)
...
OSStatus _err;
EventMask outMask;
#if !defined(GetModalDialogEventMask)
...
PyObject *_res = NULL;
TEHandle _rv;
#if !defined(GetDialogTextEditHandle)
...
PyObject *_res = NULL;
SInt16 _rv;
#if !defined(GetDialogDefaultItem)
...
PyObject *_res = NULL;
SInt16 _rv;
#if !defined(GetDialogCancelItem)
...
PyObject *_res = NULL;
SInt16 _rv;
#if !defined(GetDialogKeyboardFocusItem)
...
sizeof(DialogObject),
0,
(destructor) DlgObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) DlgObj_compare,
(reprfunc) DlgObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) DlgObj_hash,
0,
0,
