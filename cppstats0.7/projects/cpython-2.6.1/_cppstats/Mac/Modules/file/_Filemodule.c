...
sizeof(FSCatalogInfoObject),
0,
(destructor) FSCatalogInfo_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) FSCatalogInfo_compare,
(reprfunc) FSCatalogInfo_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) FSCatalogInfo_hash,
0,
0,
...
0,
0,
FSCatalogInfo_methods,
0,
FSCatalogInfo_getsetlist,
0,
0,
0,
0,
0,
FSCatalogInfo_tp_init,
FSCatalogInfo_tp_alloc,
FSCatalogInfo_tp_new,
FSCatalogInfo_tp_free,
};
#if !defined(__LP64__)
...
sizeof(FInfoObject),
0,
(destructor) FInfo_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) FInfo_compare,
(reprfunc) FInfo_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
sizeof(AliasObject),
0,
(destructor) Alias_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) Alias_compare,
(reprfunc) Alias_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
sizeof(FSSpecObject),
0,
(destructor) FSSpec_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) FSSpec_compare,
(reprfunc) FSSpec_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) FSSpec_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
sizeof(FSRefObject),
0,
(destructor) FSRef_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) FSRef_compare,
(reprfunc) FSRef_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
