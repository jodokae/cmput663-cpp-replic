...
0,
"_CG.CGContextRef",
sizeof(CGContextRefObject),
0,
(destructor) CGContextRefObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) CGContextRefObj_compare,
(reprfunc) CGContextRefObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) CGContextRefObj_hash,
0,
0,
...
0,
CGContextRefObj_getsetlist,
0,
0,
0,
0,
0,
CGContextRefObj_tp_init,
CGContextRefObj_tp_alloc,
CGContextRefObj_tp_new,
CGContextRefObj_tp_free,
};
#if !defined(__LP64__)
