...
PyObject *_res = NULL;
const BitMap * _rv;
#if !defined(GetPortBitMapForCopyBits)
...
PyObject *_res = NULL;
short _rv;
#if !defined(GetPortFracHPenLocation)
...
PyObject *_res = NULL;
short _rv;
#if !defined(GetPortPenVisibility)
...
RgnHandle _rv;
RgnHandle visRgn;
#if !defined(GetPortVisibleRegion)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsPortRegionBeingDefined)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsPortPictureBeingDefined)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsPortPolyBeingDefined)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsPortVisibleRegionEmpty)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsPortClipRegionEmpty)
...
PyObject *_res = NULL;
RgnHandle ioRegion;
#if !defined(SectRegionWithPortClipRegion)
...
PyObject *_res = NULL;
RgnHandle ioRegion;
#if !defined(SectRegionWithPortVisibleRegion)
...
Handle _rv;
Handle inPicSaveHdl;
#if !defined(SwapPortPicSaveHandle)
...
#if !defined(SwapPortPolySaveHandle)
...
#if !defined(SwapPortRegionSaveHandle)
...
PyObject *_res = NULL;
RgnHandle visRgn;
#if !defined(SetPortVisibleRegion)
...
PyObject *_res = NULL;
short pnLocHFrac;
#if !defined(SetPortFracHPenLocation)
...
PyObject *_res = NULL;
Point point;
#if !defined(QDLocalToGlobalPoint)
...
PyObject *_res = NULL;
Point point;
#if !defined(QDGlobalToLocalPoint)
...
PyObject *_res = NULL;
Rect bounds;
#if !defined(QDLocalToGlobalRect)
...
PyObject *_res = NULL;
Rect bounds;
#if !defined(QDGlobalToLocalRect)
...
RgnHandle _rv;
RgnHandle region;
#if !defined(QDLocalToGlobalRegion)
...
RgnHandle _rv;
RgnHandle region;
#if !defined(QDGlobalToLocalRegion)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(QDIsPortBufferDirty)
...
0,
"_Qd.GrafPort",
sizeof(GrafPortObject),
0,
(destructor) GrafObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) GrafObj_compare,
(reprfunc) GrafObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) GrafObj_hash,
0,
0,
...
sizeof(BitMapObject),
0,
(destructor) BMObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) BMObj_compare,
(reprfunc) BMObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
GDHandle gdh;
short attribute;
#if !defined(TestDeviceAttribute)
...
PyObject *_res = NULL;
long _rv;
#if !defined(GetQDGlobalsRandomSeed)
...
PyObject *_res = NULL;
BitMap screenBits;
#if !defined(GetQDGlobalsScreenBits)
...
#if !defined(GetQDGlobalsDarkGray)
...
#if !defined(GetQDGlobalsLightGray)
...
PyObject *_res = NULL;
CGrafPtr _rv;
#if !defined(GetQDGlobalsThePort)
...
PyObject *_res = NULL;
long randomSeed;
#if !defined(SetQDGlobalsRandomSeed)
...
Boolean _rv;
RgnHandle region;
#if !defined(IsRegionRectangular)
...
PyObject *_res = NULL;
Handle _rv;
#if !defined(LMGetWidthTabHandle)
...
PyObject *_res = NULL;
Handle value;
#if !defined(LMSetWidthTabHandle)
