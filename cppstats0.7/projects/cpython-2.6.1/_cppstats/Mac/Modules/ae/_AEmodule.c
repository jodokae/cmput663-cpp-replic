...
PyObject *_res = NULL;
OSErr _err;
#if !defined(AESuspendTheCurrentEvent)
...
PyObject *dispatcher;
#if !defined(AEResumeTheCurrentEvent)
...
PyObject *_res = NULL;
OSErr _err;
#if !defined(AEGetTheCurrentEvent)
...
PyObject *_res = NULL;
OSErr _err;
#if !defined(AESetTheCurrentEvent)
...
sizeof(AEDescObject),
0,
(destructor) AEDesc_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) AEDesc_compare,
(reprfunc) AEDesc_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
#if !defined(AEProcessAppleEvent)
...
#if !defined(AEGetInteractionAllowed)
...
OSErr _err;
AEInteractAllowed level;
#if !defined(AESetInteractionAllowed)
...
PyObject *handler;
#if !defined(AEInstallEventHandler)
...
AEEventClass theAEEventClass;
AEEventID theAEEventID;
#if !defined(AERemoveEventHandler)
...
#if !defined(AEInstallSpecialHandler)
...
OSErr _err;
AEKeyword functionClass;
#if !defined(AERemoveSpecialHandler)
...
AEDesc keyData;
AEDesc token;
#if !defined(AECallObjectAccessor)
