...
p_itself->base = NULL;
else if ( !TimeBaseObj_Convert(base, &p_itself->base) )
return 0;
return 1;
}
static int
...
0,
"_Qt.IdleManager",
sizeof(IdleManagerObject),
0,
(destructor) IdleManagerObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) IdleManagerObj_compare,
(reprfunc) IdleManagerObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) IdleManagerObj_hash,
0,
0,
...
0,
0,
IdleManagerObj_methods,
0,
IdleManagerObj_getsetlist,
0,
0,
0,
0,
...
IdleManagerObj_tp_alloc,
IdleManagerObj_tp_new,
IdleManagerObj_tp_free,
};
...
ComponentResult _rv;
Boolean attach;
#if !defined(MCSetControllerAttached)
...
PyObject *_res = NULL;
ComponentResult _rv;
#if !defined(MCIsControllerAttached)
...
ComponentResult _rv;
CGrafPtr gp;
#if !defined(MCSetControllerPort)
...
PyObject *_res = NULL;
CGrafPtr _rv;
#if !defined(MCGetControllerPort)
...
ComponentResult _rv;
Rect bounds;
#if !defined(MCGetControllerBoundsRect)
...
ComponentResult _rv;
Rect bounds;
#if !defined(MCSetControllerBoundsRect)
...
PyObject *_res = NULL;
RgnHandle _rv;
#if !defined(MCGetControllerBoundsRgn)
...
WindowPtr w;
Point where;
#if !defined(MCNewAttachedController)
...
Rect controllerRect;
long someFlags;
#if !defined(MCPositionController)
...
ComponentResult _rv;
long someFlags;
#if !defined(MCGetControllerInfo)
...
void * element;
#if !defined(MCGetInterfaceElement)
...
long flags;
long flagsMask;
#if !defined(MCSetControllerCapabilities)
...
0,
"_Qt.MovieController",
sizeof(MovieControllerObject),
0,
(destructor) MovieCtlObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) MovieCtlObj_compare,
(reprfunc) MovieCtlObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) MovieCtlObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
TimeScale s;
TimeRecord tr;
#if !defined(GetTimeBaseStartTime)
...
PyObject *_res = NULL;
TimeRecord tr;
#if !defined(SetTimeBaseStartTime)
...
TimeScale s;
TimeRecord tr;
#if !defined(GetTimeBaseStopTime)
...
PyObject *_res = NULL;
TimeRecord tr;
#if !defined(SetTimeBaseStopTime)
...
#if !defined(SetTimeBaseMasterTimeBase)
...
PyObject *_res = NULL;
TimeBase _rv;
#if !defined(GetTimeBaseMasterTimeBase)
...
TimeRecord slaveZero;
#if !defined(SetTimeBaseMasterClock)
...
#if !defined(GetTimeBaseMasterClock)
...
PyObject *_res = NULL;
Fixed _rv;
#if !defined(GetTimeBaseEffectiveRate)
...
0,
"_Qt.TimeBase",
sizeof(TimeBaseObject),
0,
(destructor) TimeBaseObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) TimeBaseObj_compare,
(reprfunc) TimeBaseObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) TimeBaseObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
long _rv;
OSType udType;
#if !defined(GetNextUserDataType)
...
OSErr _err;
Handle h;
#if !defined(PutUserDataIntoHandle)
...
0,
"_Qt.UserData",
sizeof(UserDataObject),
0,
(destructor) UserDataObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) UserDataObj_compare,
(reprfunc) UserDataObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetMediaCreationTime)
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetMediaModificationTime)
...
#if !defined(GetMediaHandlerDescription)
...
OSErr _err;
short index;
#if !defined(SetMediaDefaultDataRefIndex)
...
Str255 creatorName;
OSType creatorManufacturer;
#if !defined(GetMediaDataHandlerDescription)
...
DataHandler _rv;
short index;
#if !defined(GetMediaDataHandler)
...
#if !defined(SetMediaDataHandler)
...
PyObject *_res = NULL;
long _rv;
#if !defined(GetMediaSampleDescriptionCount)
...
#if !defined(GetMediaSampleDescription)
...
long index;
SampleDescriptionHandle descH;
#if !defined(SetMediaSampleDescription)
...
PyObject *_res = NULL;
long _rv;
#if !defined(GetMediaSampleCount)
...
PyObject *_res = NULL;
long _rv;
#if !defined(GetMediaSyncSampleCount)
...
#if !defined(SampleNumToMediaTime)
...
TimeValue sampleTime;
TimeValue sampleDuration;
#if !defined(MediaTimeToSampleNum)
...
short sampleFlags;
TimeValue sampleTime;
#if !defined(AddMediaSampleReference)
...
long numberOfSamples;
short sampleFlags;
#if !defined(GetMediaSampleReference)
...
OSErr _err;
long maxChunkSize;
#if !defined(SetMediaPreferredChunkSize)
...
OSErr _err;
long maxChunkSize;
#if !defined(GetMediaPreferredChunkSize)
...
#if !defined(GetMediaNextInterestingTime)
...
short index;
long dataRefAttributes;
#if !defined(SetMediaDataRefAttributes)
...
OSErr _err;
short count;
#if !defined(GetMediaDataRefCount)
...
Fixed rate;
TimeValue interestingTime;
#if !defined(GetMediaNextInterestingTimeOnly)
...
sizeof(MediaObject),
0,
(destructor) MediaObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) MediaObj_compare,
(reprfunc) MediaObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) MediaObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
PyObject *_res = NULL;
RgnHandle _rv;
#if !defined(GetTrackDisplayBoundsRgn)
...
PyObject *_res = NULL;
RgnHandle _rv;
#if !defined(GetTrackMovieBoundsRgn)
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetTrackCreationTime)
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetTrackModificationTime)
...
OSErr _err;
Handle settings;
#if !defined(GetTrackSoundLocalizationSettings)
...
OSErr _err;
Handle settings;
#if !defined(SetTrackSoundLocalizationSettings)
...
Fixed mediaRate;
#if !defined(InsertMediaIntoTrack)
...
#if !defined(InsertEmptyTrackSegment)
...
OSType dataRefType;
Track dstTrack;
#if !defined(AddEmptyTrackToMovie)
...
long flags;
Track dstTrack;
#if !defined(AddClonedTrackToMovie)
...
OSType refType;
long index;
#if !defined(DeleteTrackReference)
...
OSType _rv;
OSType refType;
#if !defined(GetNextTrackReferenceType)
...
long _rv;
OSType refType;
#if !defined(GetTrackReferenceCount)
...
TimeValue interestingTime;
TimeValue interestingDuration;
#if !defined(GetTrackNextInterestingTime)
...
TimeValue time;
TimeValue duration;
#if !defined(GetTrackSegmentDisplayBoundsRgn)
...
long preloadFlags;
long defaultHints;
#if !defined(SetTrackLoadSettings)
...
long preloadFlags;
long defaultHints;
#if !defined(GetTrackLoadSettings)
...
sizeof(TrackObject),
0,
(destructor) TrackObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) TrackObj_compare,
(reprfunc) TrackObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) TrackObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
PyObject *_res = NULL;
OSErr err;
#if !defined(AbortPrePrerollMovie)
...
PyObject *_res = NULL;
#if !defined(GoToBeginningOfMovie)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(GetMoviePreviewMode)
...
PyObject *_res = NULL;
Boolean usePreview;
#if !defined(SetMoviePreviewMode)
...
TimeBase tb;
TimeRecord slaveZero;
#if !defined(SetMovieMasterTimeBase)
...
Component clockMeister;
TimeRecord slaveZero;
#if !defined(SetMovieMasterClock)
...
PyObject *_res = NULL;
Rect naturalBounds;
#if !defined(GetMovieNaturalBoundsRect)
...
Track _rv;
Track theTrack;
#if !defined(GetNextTrackForCompositing)
...
Track _rv;
Track theTrack;
#if !defined(GetPrevTrackForCompositing)
...
OSErr _err;
RgnHandle invalidRgn;
#if !defined(InvalidateMovieRegion)
...
PyObject *_res = NULL;
RgnHandle _rv;
#if !defined(GetMovieDisplayClipRgn)
...
PyObject *_res = NULL;
RgnHandle theClip;
#if !defined(SetMovieDisplayClipRgn)
...
PyObject *_res = NULL;
RgnHandle _rv;
#if !defined(GetMovieDisplayBoundsRgn)
...
#if !defined(SetMovieVideoOutput)
...
long offset;
long maxSize;
#if !defined(PutMovieIntoDataFork)
...
#if !defined(PutMovieIntoDataFork64)
...
wide offset;
unsigned long maxSize;
#if !defined(PutMovieIntoStorage)
...
OSType dataRefType;
Handle publicMovie;
#if !defined(PutMovieForDataRefIntoHandle)
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetMovieCreationTime)
...
PyObject *_res = NULL;
unsigned long _rv;
#if !defined(GetMovieModificationTime)
...
PyObject *_res = NULL;
Fixed _rv;
#if !defined(GetMoviePreferredRate)
...
PyObject *_res = NULL;
Fixed rate;
#if !defined(SetMoviePreferredRate)
...
PyObject *_res = NULL;
short _rv;
#if !defined(GetMoviePreferredVolume)
...
PyObject *_res = NULL;
short volume;
#if !defined(SetMoviePreferredVolume)
...
#if !defined(GetMoviePreviewTime)
...
TimeValue previewTime;
TimeValue previewDuration;
#if !defined(SetMoviePreviewTime)
...
TimeValue startTime;
TimeValue duration;
#if !defined(SetMovieActiveSegment)
...
TimeValue startTime;
TimeValue duration;
#if !defined(GetMovieActiveSegment)
...
OSType trackType;
long flags;
#if !defined(GetMovieIndTrackType)
...
PyObject *_res = NULL;
Boolean enable;
#if !defined(SetAutoTrackAlternatesEnabled)
...
PyObject *_res = NULL;
#if !defined(SelectMovieAlternates)
...
TimeValue dstIn;
TimeValue dstDuration;
#if !defined(InsertEmptyMovieSegment)
...
PyObject *_res = NULL;
Movie src;
#if !defined(PasteMovieSelection)
...
PyObject *_res = NULL;
#if !defined(ClearMovieSelection)
...
#if !defined(PutMovieIntoTypedHandle)
...
TimeValue interestingTime;
TimeValue interestingDuration;
#if !defined(GetMovieNextInterestingTime)
...
short resId;
Str255 resName;
#if !defined(UpdateMovieResource)
...
OSErr _err;
DataHandler dh;
#if !defined(UpdateMovieInStorage)
...
Handle dataRef;
OSType dataRefType;
#if !defined(SetMovieDefaultDataRef)
...
Handle dataRef;
OSType dataRefType;
#if !defined(GetMovieDefaultDataRef)
...
ScriptCode scriptTag;
long createMovieFileFlags;
#if !defined(FlattenMovieDataToDataRef)
...
TimeValue time;
TimeValue duration;
#if !defined(GetMovieSegmentDisplayBoundsRgn)
...
OSErr _err;
TimeValue time;
#if !defined(GetMaxLoadedTimeInMovie)
...
#if !defined(QTMovieNeedsTimeTable)
...
Handle dataRef;
long offset;
#if !defined(QTGetDataRefMaxFileOffset)
...
sizeof(MovieObject),
0,
(destructor) MovieObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) MovieObj_compare,
(reprfunc) MovieObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) MovieObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
0,
"_Qt.SGOutput",
sizeof(SGOutputObject),
0,
(destructor) SGOutputObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) SGOutputObj_compare,
(reprfunc) SGOutputObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) SGOutputObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
PyObject *_res = NULL;
#if !defined(ClearMoviesStickyError)
...
PyObject *_res = NULL;
OSErr _err;
#if !defined(GetMoviesStickyError)
...
#if !defined(QTGetWallClockTimeBase)
...
long duration;
long scale;
#if !defined(QTGetTimeUntilNextTask)
...
long flags;
ComponentInstance userComp;
#if !defined(PasteHandleIntoMovie)
...
long flags;
Component importer;
#if !defined(GetMovieImporterForDataRef)
...
TimeValue value;
Track theTrack;
#if !defined(TrackTimeToMediaTime)
...
Handle h;
UserData theUserData;
#if !defined(NewUserDataFromHandle)
...
short newMovieFlags;
Boolean dataRefWasChanged;
#if !defined(NewMovieFromDataFork)
...
short newMovieFlags;
Boolean dataRefWasChanged;
#if !defined(NewMovieFromDataFork64)
...
Handle dataRef;
OSType dtaRefType;
#if !defined(NewMovieFromDataRef)
...
#if !defined(NewMovieFromStorageOffset)
...
Handle dataRef;
OSType dataRefType;
#if !defined(NewMovieForDataRefFromHandle)
...
short resRefNum;
short resId;
#if !defined(RemoveMovieResource)
...
#if !defined(CreateShortcutMovieFile)
...
UInt32 inFlags;
#if !defined(CanQuickTimeOpenFile)
...
Boolean outPreferGraphicsImporter;
UInt32 inFlags;
#if !defined(CanQuickTimeOpenDataRef)
...
Handle extension;
OSType idType;
#if !defined(AddSoundDescriptionExtension)
...
Handle extension;
OSType idType;
#if !defined(GetSoundDescriptionExtension)
...
SoundDescriptionHandle desc;
OSType idType;
#if !defined(RemoveSoundDescriptionExtension)
...
#if !defined(QTIsStandardParameterDialogEvent)
...
OSErr _err;
QTParameterDialog createdDialog;
#if !defined(QTDismissStandardParameterDialog)
...
long action;
void * params;
#if !defined(QTStandardParameterDialogDoAction)
...
long flags;
Handle accessKey;
#if !defined(QTRegisterAccessKey)
...
long flags;
Handle accessKey;
#if !defined(QTUnregisterAccessKey)
...
#if !defined(QTGetSupportedRestrictions)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(VideoMediaResetStatistics)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(VideoMediaGetStatistics)
...
#if !defined(VideoMediaGetStallCount)
...
void * dataPtr;
long dataSize;
#if !defined(VideoMediaSetCodecParameter)
...
#if !defined(VideoMediaGetCodecParameter)
...
TimeValue duration;
TimeValue sampleTime;
#if !defined(TextMediaAddTextSample)
...
TimeValue duration;
TimeValue sampleTime;
#if !defined(TextMediaAddTESample)
...
TimeValue duration;
TimeValue sampleTime;
#if !defined(TextMediaAddHiliteSample)
...
void * data;
long dataSize;
#if !defined(TextMediaSetTextProperty)
...
void * data;
long dataSize;
#if !defined(TextMediaGetTextProperty)
...
long offset;
#if !defined(TextMediaFindNextText)
...
short hiliteEnd;
RGBColor rgbHiliteColor;
#if !defined(TextMediaHiliteTextSample)
...
void * data;
OSType dataType;
#if !defined(TextMediaSetTextSampleData)
...
long propertyType;
void * propertyValue;
#if !defined(SpriteMediaSetProperty)
...
long propertyType;
void * propertyValue;
#if !defined(SpriteMediaGetProperty)
...
#if !defined(SpriteMediaHitTestSprites)
...
MediaHandler mh;
short numSprites;
#if !defined(SpriteMediaCountSprites)
...
MediaHandler mh;
short numImages;
#if !defined(SpriteMediaCountImages)
...
#if !defined(SpriteMediaGetIndImageDescription)
...
MediaHandler mh;
long sampleNum;
#if !defined(SpriteMediaGetDisplayedSampleNumber)
...
QTAtomID spriteID;
Str255 spriteName;
#if !defined(SpriteMediaGetSpriteName)
...
short imageIndex;
Str255 imageName;
#if !defined(SpriteMediaGetImageName)
...
long propertyType;
void * propertyValue;
#if !defined(SpriteMediaSetSpriteProperty)
...
long propertyType;
void * propertyValue;
#if !defined(SpriteMediaGetSpriteProperty)
...
#if !defined(SpriteMediaHitTestAllSprites)
...
Point loc;
Boolean wasHit;
#if !defined(SpriteMediaHitTestOneSprite)
...
short spriteIndex;
QTAtomID spriteID;
#if !defined(SpriteMediaSpriteIndexToID)
...
QTAtomID spriteID;
short spriteIndex;
#if !defined(SpriteMediaSpriteIDToIndex)
...
QTAtomID variableID;
float value;
#if !defined(SpriteMediaSetActionVariable)
...
QTAtomID variableID;
float value;
#if !defined(SpriteMediaGetActionVariable)
...
MediaHandler mh;
QTAtomID spriteID;
#if !defined(SpriteMediaDisposeSprite)
...
QTAtomID variableID;
Ptr theCString;
#if !defined(SpriteMediaSetActionVariableToString)
...
QTAtomID variableID;
Handle theCString;
#if !defined(SpriteMediaGetActionVariableAsString)
...
OSType dataRefType;
QTAtomID desiredID;
#if !defined(SpriteMediaNewImage)
...
MediaHandler mh;
short imageIndex;
#if !defined(SpriteMediaDisposeImage)
...
short imageIndex;
QTAtomID imageID;
#if !defined(SpriteMediaImageIndexToID)
...
QTAtomID imageID;
short imageIndex;
#if !defined(SpriteMediaImageIDToIndex)
...
long right;
long bottom;
#if !defined(FlashMediaSetZoomRect)
...
long right;
long bottom;
#if !defined(FlashMediaGetRefConBounds)
...
long refCon;
long refConID;
#if !defined(FlashMediaGetRefConID)
...
long refConID;
long refCon;
#if !defined(FlashMediaIDToRefCon)
...
#if !defined(FlashMediaGetDisplayedFrameNumber)
...
long flashFrameNumber;
TimeValue movieTime;
#if !defined(FlashMediaFrameNumberToMovieTime)
...
Ptr theLabel;
TimeValue movieTime;
#if !defined(FlashMediaFrameLabelToMovieTime)
...
#if !defined(FlashMediaGetFlashVariable)
...
char value;
Boolean updateFocus;
#if !defined(FlashMediaSetFlashVariable)
...
long buttonID;
long transition;
#if !defined(FlashMediaDoButtonActions)
...
MediaHandler mh;
UInt8 swfVersion;
#if !defined(FlashMediaGetSupportedSwfVersion)
...
MediaHandler mh;
void * group;
#if !defined(Media3DGetCurrentGroup)
...
Fixed y;
Fixed z;
#if !defined(Media3DTranslateNamedObjectTo)
...
Fixed yScale;
Fixed zScale;
#if !defined(Media3DScaleNamedObjectTo)
...
Fixed yDegrees;
Fixed zDegrees;
#if !defined(Media3DRotateNamedObjectTo)
...
MediaHandler mh;
void * cameraData;
#if !defined(Media3DSetCameraData)
...
MediaHandler mh;
void * cameraData;
#if !defined(Media3DGetCameraData)
...
#if !defined(Media3DSetCameraAngleAspect)
...
QTFloatSingle fov;
QTFloatSingle aspectRatioXToY;
#if !defined(Media3DGetCameraAngleAspect)
...
MediaHandler mh;
void * tQ3CameraRange;
#if !defined(Media3DSetCameraRange)
...
MediaHandler mh;
void * tQ3CameraRange;
#if !defined(Media3DGetCameraRange)
...
#if !defined(MusicMediaGetIndexedTunePlayer)
...
OSErr _err;
long version;
#if !defined(CodecManagerVersion)
...
long size;
#if !defined(GetMaxCompressionSize)
...
ImageDescriptionHandle desc;
CTabHandle ctable;
#if !defined(GetImageDescriptionCTable)
...
ImageDescriptionHandle desc;
CTabHandle ctable;
#if !defined(SetImageDescriptionCTable)
...
long idType;
long index;
#if !defined(GetImageDescriptionExtension)
...
Handle extension;
long idType;
#if !defined(AddImageDescriptionExtension)
...
long idType;
long index;
#if !defined(RemoveImageDescriptionExtension)
...
long idType;
long count;
#if !defined(CountImageDescriptionExtensionType)
...
ImageDescriptionHandle desc;
long idType;
#if !defined(GetNextImageDescriptionExtensionType)
...
CodecQ quality;
CodecType cType;
#if !defined(CompressPictureFile)
...
#if !defined(GetGraphicsImporterForFile)
...
OSType dataRefType;
ComponentInstance gi;
#if !defined(GetGraphicsImporterForDataRef)
...
ComponentInstance gi;
long flags;
#if !defined(GetGraphicsImporterForFileWithFlags)
...
ComponentInstance gi;
long flags;
#if !defined(GetGraphicsImporterForDataRefWithFlags)
...
#if !defined(MakeImageDescriptionForPixMap)
...
OSType effectType;
ImageDescriptionHandle idh;
#if !defined(MakeImageDescriptionForEffect)
...
short _rv;
OSType PixelFormat;
#if !defined(QTGetPixelFormatDepthForImageDescription)
...
long _rv;
PixMapHandle pm;
#if !defined(QTGetPixMapHandleRowBytes)
...
PixMapHandle pm;
long rowBytes;
#if !defined(QTSetPixMapHandleRowBytes)
...
Fixed _rv;
PixMapHandle pm;
#if !defined(QTGetPixMapHandleGammaLevel)
...
PixMapHandle pm;
Fixed gammaLevel;
#if !defined(QTSetPixMapHandleGammaLevel)
...
Fixed _rv;
PixMapHandle pm;
#if !defined(QTGetPixMapHandleRequestedGammaLevel)
...
#if !defined(QTSetPixMapHandleRequestedGammaLevel)
...
Handle dataRef;
OSType dataReType;
#if !defined(GraphicsImportSetDataReference)
...
Handle dataRef;
OSType dataReType;
#if !defined(GraphicsImportGetDataReference)
...
GraphicsImportComponent ci;
FSSpec theFile;
#if !defined(GraphicsImportSetDataFile)
...
GraphicsImportComponent ci;
FSSpec theFile;
#if !defined(GraphicsImportGetDataFile)
...
GraphicsImportComponent ci;
Handle h;
#if !defined(GraphicsImportSetDataHandle)
...
GraphicsImportComponent ci;
Handle h;
#if !defined(GraphicsImportGetDataHandle)
...
GraphicsImportComponent ci;
ImageDescriptionHandle desc;
#if !defined(GraphicsImportGetImageDescription)
...
unsigned long size;
#if !defined(GraphicsImportGetDataOffsetAndSize)
...
#if !defined(GraphicsImportReadData)
...
GraphicsImportComponent ci;
RgnHandle clipRgn;
#if !defined(GraphicsImportSetClip)
...
GraphicsImportComponent ci;
RgnHandle clipRgn;
#if !defined(GraphicsImportGetClip)
...
GraphicsImportComponent ci;
Rect sourceRect;
#if !defined(GraphicsImportSetSourceRect)
...
GraphicsImportComponent ci;
Rect sourceRect;
#if !defined(GraphicsImportGetSourceRect)
...
GraphicsImportComponent ci;
Rect naturalBounds;
#if !defined(GraphicsImportGetNaturalBounds)
...
CGrafPtr port;
GDHandle gd;
#if !defined(GraphicsImportSetGWorld)
...
CGrafPtr port;
GDHandle gd;
#if !defined(GraphicsImportGetGWorld)
...
GraphicsImportComponent ci;
Rect bounds;
#if !defined(GraphicsImportSetBoundsRect)
...
GraphicsImportComponent ci;
Rect bounds;
#if !defined(GraphicsImportGetBoundsRect)
...
FSSpec fss;
ScriptCode scriptTag;
#if !defined(GraphicsImportSaveAsPicture)
...
long graphicsMode;
RGBColor opColor;
#if !defined(GraphicsImportSetGraphicsMode)
...
long graphicsMode;
RGBColor opColor;
#if !defined(GraphicsImportGetGraphicsMode)
...
GraphicsImportComponent ci;
CodecQ quality;
#if !defined(GraphicsImportSetQuality)
...
GraphicsImportComponent ci;
CodecQ quality;
#if !defined(GraphicsImportGetQuality)
...
FSSpec fss;
ScriptCode scriptTag;
#if !defined(GraphicsImportSaveAsQuickTimeImageFile)
...
unsigned long offset;
unsigned long limit;
#if !defined(GraphicsImportSetDataReferenceOffsetAndLimit)
...
unsigned long offset;
unsigned long limit;
#if !defined(GraphicsImportGetDataReferenceOffsetAndLimit)
...
Handle dataRef;
OSType dataRefType;
#if !defined(GraphicsImportGetAliasedDataReference)
...
GraphicsImportComponent ci;
Boolean valid;
#if !defined(GraphicsImportValidate)
...
GraphicsImportComponent ci;
void * userData;
#if !defined(GraphicsImportGetMetaData)
...
#if !defined(GraphicsImportGetMIMETypeList)
...
#if !defined(GraphicsImportDoesDrawAllPixels)
...
GraphicsImportComponent ci;
PicHandle picture;
#if !defined(GraphicsImportGetAsPicture)
...
FSSpec fss;
ScriptCode scriptTag;
#if !defined(GraphicsImportExportImageFile)
...
GraphicsImportComponent ci;
void * qtAtomContainerPtr;
#if !defined(GraphicsImportGetExportImageTypeList)
...
GraphicsImportComponent ci;
void * qtAtomContainerPtr;
#if !defined(GraphicsImportGetExportSettingsAsAtomContainer)
...
#if !defined(GraphicsImportSetExportSettingsFromAtomContainer)
...
#if !defined(GraphicsImportGetImageCount)
...
#if !defined(GraphicsImportSetImageIndex)
...
GraphicsImportComponent ci;
unsigned long imageIndex;
#if !defined(GraphicsImportGetImageIndex)
...
wide offset;
wide size;
#if !defined(GraphicsImportGetDataOffsetAndSize64)
...
wide dataOffset;
unsigned long dataSize;
#if !defined(GraphicsImportReadData64)
...
wide offset;
wide limit;
#if !defined(GraphicsImportSetDataReferenceOffsetAndLimit64)
...
wide offset;
wide limit;
#if !defined(GraphicsImportGetDataReferenceOffsetAndLimit64)
...
#if !defined(GraphicsImportGetDefaultClip)
...
#if !defined(GraphicsImportGetDefaultGraphicsMode)
...
#if !defined(GraphicsImportGetDefaultSourceRect)
...
GraphicsImportComponent ci;
Handle profile;
#if !defined(GraphicsImportGetColorSyncProfile)
...
GraphicsImportComponent ci;
Rect destRect;
#if !defined(GraphicsImportSetDestRect)
...
GraphicsImportComponent ci;
Rect destRect;
#if !defined(GraphicsImportGetDestRect)
...
GraphicsImportComponent ci;
long flags;
#if !defined(GraphicsImportSetFlags)
...
GraphicsImportComponent ci;
long flags;
#if !defined(GraphicsImportGetFlags)
...
wide offset;
wide size;
#if !defined(GraphicsImportGetBaseDataOffsetAndSize64)
...
ComponentResult _rv;
GraphicsImportComponent ci;
#if !defined(GraphicsImportSetImageIndexToThumbnail)
...
#if !defined(GraphicsExportDoExport)
...
#if !defined(GraphicsExportCanTranscode)
...
ComponentResult _rv;
GraphicsExportComponent ci;
#if !defined(GraphicsExportDoTranscode)
...
#if !defined(GraphicsExportCanUseCompressor)
...
#if !defined(GraphicsExportDoUseCompressor)
...
ComponentResult _rv;
GraphicsExportComponent ci;
#if !defined(GraphicsExportDoStandaloneExport)
...
OSType fileType;
OSType fileCreator;
#if !defined(GraphicsExportGetDefaultFileTypeAndCreator)
...
GraphicsExportComponent ci;
OSType fileNameExtension;
#if !defined(GraphicsExportGetDefaultFileNameExtension)
...
GraphicsExportComponent ci;
void * qtAtomContainerPtr;
#if !defined(GraphicsExportGetMIMETypeList)
...
GraphicsExportComponent ci;
void * qtAtomContainer;
#if !defined(GraphicsExportSetSettingsFromAtomContainer)
...
GraphicsExportComponent ci;
void * qtAtomContainerPtr;
#if !defined(GraphicsExportGetSettingsAsAtomContainer)
...
GraphicsExportComponent ci;
Handle theText;
#if !defined(GraphicsExportGetSettingsAsText)
...
#if !defined(GraphicsExportSetDontRecompress)
...
GraphicsExportComponent ci;
Boolean dontRecompress;
#if !defined(GraphicsExportGetDontRecompress)
...
#if !defined(GraphicsExportSetInterlaceStyle)
...
GraphicsExportComponent ci;
unsigned long interlaceStyle;
#if !defined(GraphicsExportGetInterlaceStyle)
...
GraphicsExportComponent ci;
void * userData;
#if !defined(GraphicsExportSetMetaData)
...
GraphicsExportComponent ci;
void * userData;
#if !defined(GraphicsExportGetMetaData)
...
#if !defined(GraphicsExportSetTargetDataSize)
...
GraphicsExportComponent ci;
unsigned long targetDataSize;
#if !defined(GraphicsExportGetTargetDataSize)
...
#if !defined(GraphicsExportSetCompressionMethod)
...
GraphicsExportComponent ci;
long compressionMethod;
#if !defined(GraphicsExportGetCompressionMethod)
...
GraphicsExportComponent ci;
CodecQ spatialQuality;
#if !defined(GraphicsExportSetCompressionQuality)
...
GraphicsExportComponent ci;
CodecQ spatialQuality;
#if !defined(GraphicsExportGetCompressionQuality)
...
#if !defined(GraphicsExportSetResolution)
...
Fixed horizontalResolution;
Fixed verticalResolution;
#if !defined(GraphicsExportGetResolution)
...
GraphicsExportComponent ci;
long depth;
#if !defined(GraphicsExportSetDepth)
...
GraphicsExportComponent ci;
long depth;
#if !defined(GraphicsExportGetDepth)
...
#if !defined(GraphicsExportSetColorSyncProfile)
...
GraphicsExportComponent ci;
Handle colorSyncProfile;
#if !defined(GraphicsExportGetColorSyncProfile)
...
OSType dataRefType;
ImageDescriptionHandle desc;
#if !defined(GraphicsExportSetInputDataReference)
...
Handle dataRef;
OSType dataRefType;
#if !defined(GraphicsExportGetInputDataReference)
...
FSSpec theFile;
ImageDescriptionHandle desc;
#if !defined(GraphicsExportSetInputFile)
...
GraphicsExportComponent ci;
FSSpec theFile;
#if !defined(GraphicsExportGetInputFile)
...
Handle h;
ImageDescriptionHandle desc;
#if !defined(GraphicsExportSetInputHandle)
...
GraphicsExportComponent ci;
Handle h;
#if !defined(GraphicsExportGetInputHandle)
...
unsigned long size;
ImageDescriptionHandle desc;
#if !defined(GraphicsExportSetInputPtr)
...
#if !defined(GraphicsExportSetInputGraphicsImporter)
...
GraphicsExportComponent ci;
GraphicsImportComponent grip;
#if !defined(GraphicsExportGetInputGraphicsImporter)
...
GraphicsExportComponent ci;
PicHandle picture;
#if !defined(GraphicsExportSetInputPicture)
...
GraphicsExportComponent ci;
PicHandle picture;
#if !defined(GraphicsExportGetInputPicture)
...
GraphicsExportComponent ci;
GWorldPtr gworld;
#if !defined(GraphicsExportSetInputGWorld)
...
GraphicsExportComponent ci;
GWorldPtr gworld;
#if !defined(GraphicsExportGetInputGWorld)
...
GraphicsExportComponent ci;
PixMapHandle pixmap;
#if !defined(GraphicsExportSetInputPixmap)
...
GraphicsExportComponent ci;
PixMapHandle pixmap;
#if !defined(GraphicsExportGetInputPixmap)
...
unsigned long offset;
unsigned long limit;
#if !defined(GraphicsExportSetInputOffsetAndLimit)
...
unsigned long offset;
unsigned long limit;
#if !defined(GraphicsExportGetInputOffsetAndLimit)
...
#if !defined(GraphicsExportMayExporterReadInputData)
...
GraphicsExportComponent ci;
unsigned long size;
#if !defined(GraphicsExportGetInputDataSize)
...
unsigned long dataOffset;
unsigned long dataSize;
#if !defined(GraphicsExportReadInputData)
...
GraphicsExportComponent ci;
ImageDescriptionHandle desc;
#if !defined(GraphicsExportGetInputImageDescription)
...
GraphicsExportComponent ci;
Rect dimensions;
#if !defined(GraphicsExportGetInputImageDimensions)
...
GraphicsExportComponent ci;
long inputDepth;
#if !defined(GraphicsExportGetInputImageDepth)
...
Rect srcRect;
Rect dstRect;
#if !defined(GraphicsExportDrawInputImage)
...
Handle dataRef;
OSType dataRefType;
#if !defined(GraphicsExportSetOutputDataReference)
...
Handle dataRef;
OSType dataRefType;
#if !defined(GraphicsExportGetOutputDataReference)
...
GraphicsExportComponent ci;
FSSpec theFile;
#if !defined(GraphicsExportSetOutputFile)
...
GraphicsExportComponent ci;
FSSpec theFile;
#if !defined(GraphicsExportGetOutputFile)
...
GraphicsExportComponent ci;
Handle h;
#if !defined(GraphicsExportSetOutputHandle)
...
GraphicsExportComponent ci;
Handle h;
#if !defined(GraphicsExportGetOutputHandle)
...
#if !defined(GraphicsExportSetOutputOffsetAndMaxSize)
...
unsigned long maxSize;
Boolean truncateFile;
#if !defined(GraphicsExportGetOutputOffsetAndMaxSize)
...
OSType fileType;
OSType fileCreator;
#if !defined(GraphicsExportSetOutputFileTypeAndCreator)
...
OSType fileType;
OSType fileCreator;
#if !defined(GraphicsExportGetOutputFileTypeAndCreator)
...
GraphicsExportComponent ci;
unsigned long mark;
#if !defined(GraphicsExportSetOutputMark)
...
GraphicsExportComponent ci;
unsigned long mark;
#if !defined(GraphicsExportGetOutputMark)
...
unsigned long dataOffset;
unsigned long dataSize;
#if !defined(GraphicsExportReadOutputData)
...
#if !defined(GraphicsExportSetThumbnailEnabled)
...
long maxThumbnailWidth;
long maxThumbnailHeight;
#if !defined(GraphicsExportGetThumbnailEnabled)
...
GraphicsExportComponent ci;
Boolean enableExif;
#if !defined(GraphicsExportSetExifEnabled)
...
GraphicsExportComponent ci;
Boolean exifEnabled;
#if !defined(GraphicsExportGetExifEnabled)
...
void * data;
long dataSize;
#if !defined(ImageTranscoderBeginSequence)
...
ImageTranscoderComponent itc;
void * dstData;
#if !defined(ImageTranscoderDisposeData)
...
ComponentResult _rv;
ImageTranscoderComponent itc;
#if !defined(ImageTranscoderEndSequence)
...
Rect testRect;
short testFlags;
#if !defined(SCSetTestImagePictHandle)
...
Rect testRect;
short testFlags;
#if !defined(SCSetTestImagePictFile)
...
Rect testRect;
short testFlags;
#if !defined(SCSetTestImagePixMap)
...
ComponentInstance ci;
Rect r;
#if !defined(SCGetBestDeviceRect)
...
ComponentResult _rv;
ComponentInstance ci;
#if !defined(SCRequestImageSettings)
...
short srcRefNum;
short dstRefNum;
#if !defined(SCCompressPictureFile)
...
ComponentResult _rv;
ComponentInstance ci;
#if !defined(SCRequestSequenceSettings)
...
Rect srcRect;
ImageDescriptionHandle desc;
#if !defined(SCCompressSequenceBegin)
...
long dataSize;
short notSyncFlag;
#if !defined(SCCompressSequenceFrame)
...
ComponentResult _rv;
ComponentInstance ci;
#if !defined(SCCompressSequenceEnd)
...
PicHandle srcPicture;
short motion;
#if !defined(SCDefaultPictHandleSettings)
...
short srcRef;
short motion;
#if !defined(SCDefaultPictFileSettings)
...
PixMapHandle src;
short motion;
#if !defined(SCDefaultPixMapSettings)
...
ComponentInstance ci;
Handle text;
#if !defined(SCGetSettingsAsText)
...
TimeValue duration;
TimeScale scale;
#if !defined(MovieImportSetSampleDuration)
...
OSType mediaType;
#if !defined(MovieImportSetSampleDescription)
...
MovieImportComponent ci;
AliasHandle alias;
#if !defined(MovieImportSetMediaFile)
...
Fixed width;
Fixed height;
#if !defined(MovieImportSetDimensions)
...
MovieImportComponent ci;
long chunkSize;
#if !defined(MovieImportSetChunkSize)
...
Handle data;
OSType handleType;
#if !defined(MovieImportSetAuxiliaryData)
...
MovieImportComponent ci;
Boolean fromScrap;
#if !defined(MovieImportSetFromScrap)
...
Handle theData;
Boolean canceled;
#if !defined(MovieImportDoUserDialog)
...
MovieImportComponent ci;
TimeValue duration;
#if !defined(MovieImportSetDuration)
...
MovieImportComponent ci;
OSType auxType;
#if !defined(MovieImportGetAuxiliaryDataType)
...
Handle theData;
Boolean valid;
#if !defined(MovieImportValidate)
...
MovieImportComponent ci;
OSType fileType;
#if !defined(MovieImportGetFileType)
...
SampleDescriptionHandle desc;
OSType mediaType;
#if !defined(MovieImportGetSampleDescription)
...
unsigned long offset;
unsigned long limit;
#if !defined(MovieImportSetOffsetAndLimit)
...
wide offset;
wide limit;
#if !defined(MovieImportSetOffsetAndLimit64)
...
OSType dataRefType;
UInt8 valid;
#if !defined(MovieImportValidateDataRef)
...
#if !defined(MovieImportGetLoadState)
...
MovieImportComponent ci;
TimeValue time;
#if !defined(MovieImportGetMaxLoadedTime)
...
MovieImportComponent ci;
TimeRecord time;
#if !defined(MovieImportEstimateCompletionTime)
...
MovieImportComponent ci;
Boolean dontBlock;
#if !defined(MovieImportSetDontBlock)
...
MovieImportComponent ci;
Boolean willBlock;
#if !defined(MovieImportGetDontBlock)
...
MovieImportComponent ci;
IdleManager im;
#if !defined(MovieImportSetIdleManager)
...
MovieImportComponent ci;
long newMovieFlags;
#if !defined(MovieImportSetNewMovieFlags)
...
MovieImportComponent ci;
OSType mediaType;
#if !defined(MovieImportGetDestinationMediaType)
...
TimeValue startTime;
TimeValue duration;
#if !defined(MovieExportToHandle)
...
Handle dataH;
OSType handleType;
#if !defined(MovieExportGetAuxiliaryData)
...
SampleDescriptionHandle desc;
OSType mediaType;
#if !defined(MovieExportSetSampleDescription)
...
TimeValue duration;
Boolean canceled;
#if !defined(MovieExportDoUserDialog)
...
MovieExportComponent ci;
OSType creator;
#if !defined(MovieExportGetCreatorType)
...
TimeValue startTime;
TimeValue duration;
#if !defined(MovieExportToDataRef)
...
Handle dataRef;
OSType dataRefType;
#if !defined(MovieExportFromProceduresToDataRef)
...
Track onlyThisTrack;
Boolean valid;
#if !defined(MovieExportValidate)
...
MovieExportComponent ci;
OSType extension;
#if !defined(MovieExportGetFileNameExtension)
...
MovieExportComponent ci;
Str255 typeString;
#if !defined(MovieExportGetShortFileTypeString)
...
MovieExportComponent ci;
OSType mediaType;
#if !defined(MovieExportGetSourceMediaType)
...
#if !defined(TextExportGetTimeFraction)
...
TextExportComponent ci;
long movieTimeFraction;
#if !defined(TextExportSetTimeFraction)
...
TextExportComponent ci;
long setting;
#if !defined(TextExportGetSettings)
...
TextExportComponent ci;
long setting;
#if !defined(TextExportSetSettings)
...
TextExportComponent ci;
long setting;
#if !defined(MIDIImportGetSettings)
...
TextExportComponent ci;
long setting;
#if !defined(MIDIImportSetSettings)
...
Boolean enable;
#if !defined(GraphicsImageImportSetSequenceEnabled)
...
GraphicImageMovieImportComponent ci;
Boolean enable;
#if !defined(GraphicsImageImportGetSequenceEnabled)
...
short resID;
FSSpec sourceFile;
#if !defined(PreviewMakePreviewReference)
...
#if !defined(DataCodecDecompress)
...
UInt32 srcSize;
UInt32 dstSize;
#if !defined(DataCodecGetCompressBufferSize)
...
#if !defined(DataCodecBeginInterruptSafe)
...
ComponentResult _rv;
DataCodecComponent dc;
#if !defined(DataCodecEndInterruptSafe)
...
Handle dataRef;
Boolean equal;
#if !defined(DataHCompareDataRef)
...
#if !defined(DataHResolveDataRef)
...
DataHandler dh;
long blockSize;
#if !defined(DataHGetPreferredBlockSize)
...
DataHandler dh;
long deviceIndex;
#if !defined(DataHGetDeviceIndex)
...
DataHandler dh;
Boolean yes;
#if !defined(DataHIsStreamingDataHandler)
...
long startOffset;
long size;
#if !defined(DataHGetDataInBuffer)
...
DataHandler dh;
long millisecs;
#if !defined(DataHGetScheduleAheadTime)
...
DataHandler dh;
Size cacheSizeLimit;
#if !defined(DataHSetCacheSizeLimit)
...
DataHandler dh;
Size cacheSizeLimit;
#if !defined(DataHGetCacheSizeLimit)
...
DataHandler dh;
long fileSize;
#if !defined(DataHGetAvailableFileSize)
...
DataHandler dh;
OSType fileType;
#if !defined(DataHGetMacOSFileType)
...
OSType dataRefType;
Handle dataRef;
#if !defined(DataHSetDataRefWithAnchor)
...
OSType dataRefType;
Handle dataRef;
#if !defined(DataHGetDataRefWithAnchor)
...
DataHandler dh;
OSType fileType;
#if !defined(DataHSetMacOSFileType)
...
DataHandler dh;
wide freeSize;
#if !defined(DataHGetFreeSpace64)
...
long missing_offset;
long missing_len;
#if !defined(DataHGetDataAvailability)
...
Handle dataRef;
#if !defined(DataHGetDataRefAsType)
...
Handle extension;
OSType idType;
#if !defined(DataHSetDataRefExtension)
...
Handle extension;
OSType idType;
#if !defined(DataHGetDataRefExtension)
...
short id;
short flags;
#if !defined(DataHGetMovieWithFlags)
...
#if !defined(DataHGetFileTypeOrdering)
...
Boolean deleteExisting;
UInt32 flags;
#if !defined(DataHCreateFileWithFlags)
...
DataHandler dh;
IdleManager im;
#if !defined(DataHSetIdleManager)
...
DataHandler dh;
long flags;
#if !defined(DataHSetMovieUsageFlags)
...
DataHandler dh;
long inFlags;
#if !defined(DataHUseTemporaryDataRef)
...
#if !defined(DataHGetTemporaryDataRefCapabilities)
...
wide maxFileOffset;
long bytesPerSecond;
#if !defined(DataHPlaybackHints64)
...
Fixed channel2;
Fixed channel3;
#if !defined(VDSetInputGammaValue)
...
Fixed channel2;
Fixed channel3;
#if !defined(VDGetInputGammaValue)
...
#if !defined(VDSetInputColorSpaceMode)
...
VideoDigitizerComponent ci;
short colorSpaceMode;
#if !defined(VDGetInputColorSpaceMode)
...
VideoDigitizerComponent ci;
unsigned short blendLevel;
#if !defined(VDSetMasterBlendLevel)
...
VideoDigitizerComponent ci;
short fieldFlag;
#if !defined(VDSetFieldPreference)
...
VideoDigitizerComponent ci;
short fieldFlag;
#if !defined(VDGetFieldPreference)
...
GrafPtr theWindow;
Rect globalRect;
#if !defined(VDPreflightGlobalRect)
...
GrafPtr theWindow;
Rect globalRect;
#if !defined(VDSetPlayThruGlobalRect)
...
#if !defined(VDSetBlackLevelValue)
...
VideoDigitizerComponent ci;
unsigned short blackLevel;
#if !defined(VDGetBlackLevelValue)
...
#if !defined(VDSetWhiteLevelValue)
...
VideoDigitizerComponent ci;
unsigned short whiteLevel;
#if !defined(VDGetWhiteLevelValue)
...
VideoDigitizerComponent ci;
short inputs;
#if !defined(VDGetNumberOfInputs)
...
VideoDigitizerComponent ci;
short buffer;
#if !defined(VDGrabOneFrameAsync)
...
ComponentResult _rv;
VideoDigitizerComponent ci;
#if !defined(VDCompressOneFrameAsync)
...
VideoDigitizerComponent ci;
ImageDescriptionHandle desc;
#if !defined(VDGetImageDescription)
...
ComponentResult _rv;
VideoDigitizerComponent ci;
#if !defined(VDResetCompressSequence)
...
VideoDigitizerComponent ci;
Boolean state;
#if !defined(VDSetCompressionOnOff)
...
#if !defined(VDGetCompressionTypes)
...
#if !defined(VDGetSoundInputDriver)
...
VideoDigitizerComponent ci;
TimeScale preferred;
#if !defined(VDGetPreferredTimeScale)
...
ComponentResult _rv;
VideoDigitizerComponent ci;
#if !defined(VDReleaseAsyncBuffers)
...
long videoInput;
long soundInput;
#if !defined(VDGetSoundInputSource)
...
CodecQ temporalQuality;
unsigned long compressTime;
#if !defined(VDGetCompressionTime)
...
#if !defined(VDSetPreferredPacketSize)
...
long width;
long height;
#if !defined(VDSetPreferredImageDimensions)
...
long width;
long height;
#if !defined(VDGetPreferredImageDimensions)
...
VideoDigitizerComponent ci;
CGrafPtr destPort;
#if !defined(VDSetDestinationPort)
...
Str255 outName;
UInt32 outNameFlags;
#if !defined(VDGetDeviceNameAndFlags)
...
VideoDigitizerComponent ci;
UInt32 inStateFlags;
#if !defined(VDCaptureStateChanging)
...
long errorLine;
StringPtr errDesc;
#if !defined(XMLParseGetDetailedParseError)
...
char attributeName;
UInt32 attributeID;
#if !defined(XMLParseAddAttribute)
...
char attributeNames;
UInt32 attributeIDs;
#if !defined(XMLParseAddMultipleAttributes)
...
#if !defined(XMLParseAddAttributeAndValue)
...
UInt32 attributeValueKind;
void * attributeValueKindInfo;
#if !defined(XMLParseAddAttributeValueKind)
...
char nameSpaceURL;
UInt32 nameSpaceID;
#if !defined(XMLParseAddNameSpace)
...
UInt32 offset;
UInt32 limit;
#if !defined(XMLParseSetOffsetAndLimit)
...
ComponentInstance aParser;
long refcon;
#if !defined(XMLParseSetEventParseRefCon)
...
SeqGrabComponent s;
unsigned long ticks;
#if !defined(SGSetMaximumRecordTime)
...
SeqGrabComponent s;
unsigned long ticks;
#if !defined(SGGetMaximumRecordTime)
...
SeqGrabComponent s;
unsigned long bytes;
#if !defined(SGGetStorageSpaceRemaining)
...
SeqGrabComponent s;
short resID;
#if !defined(SGGetLastMovieResID)
...
#if !defined(SGNewChannelFromComponent)
...
UserData ud;
long flags;
#if !defined(SGSetChannelSettings)
...
UserData ud;
long flags;
#if !defined(SGGetChannelSettings)
...
SGOutput sgOut;
unsigned long space;
#if !defined(SGGetDataOutputStorageSpaceRemaining)
...
EventRecord event;
Boolean handled;
#if !defined(SGHandleUpdateEvent)
...
SGOutput sgOut;
SGOutput nextOut;
#if !defined(SGSetOutputNextOutput)
...
SGOutput sgOut;
SGOutput nextOut;
#if !defined(SGGetOutputNextOutput)
...
SGOutput sgOut;
wide maxOffset;
#if !defined(SGSetOutputMaximumOffset)
...
SGOutput sgOut;
wide maxOffset;
#if !defined(SGGetOutputMaximumOffset)
...
Handle dataRef;
OSType dataRefType;
#if !defined(SGGetOutputDataReference)
...
wide offset;
SGOutput sgOut;
#if !defined(SGWriteExtendedMovieData)
...
SeqGrabComponent s;
wide bytes;
#if !defined(SGGetStorageSpaceRemaining64)
...
SGOutput sgOut;
wide space;
#if !defined(SGGetDataOutputStorageSpaceRemaining64)
...
#if !defined(SGAddExtendedMovieData)
...
Media theMedia;
SampleDescriptionHandle desc;
#if !defined(SGAddOutputDataRefToMedia)
...
SeqGrabComponent s;
Handle summaryText;
#if !defined(SGSetSettingsSummary)
...
SGChannel c;
long playFlags;
#if !defined(SGSetChannelPlayFlags)
...
SGChannel c;
long playFlags;
#if !defined(SGGetChannelPlayFlags)
...
SGChannel c;
long frameCount;
#if !defined(SGSetChannelMaxFrames)
...
SGChannel c;
long frameCount;
#if !defined(SGGetChannelMaxFrames)
...
SGChannel c;
Handle sampleDesc;
#if !defined(SGGetChannelSampleDescription)
...
SGChannel c;
TimeScale scale;
#if !defined(SGGetChannelTimeScale)
...
ComponentResult _rv;
SGChannel c;
#if !defined(SGChannelPutPicture)
...
SGChannel c;
long bytesPerSecond;
#if !defined(SGChannelSetRequestedDataRate)
...
SGChannel c;
long bytesPerSecond;
#if !defined(SGChannelGetRequestedDataRate)
...
Str255 name;
ScriptCode scriptTag;
#if !defined(SGChannelSetDataSourceName)
...
Str255 name;
ScriptCode scriptTag;
#if !defined(SGChannelGetDataSourceName)
...
SGChannel c;
Handle settings;
#if !defined(SGChannelSetCodecSettings)
...
SGChannel c;
Handle settings;
#if !defined(SGChannelGetCodecSettings)
...
SGChannel c;
TimeBase tb;
#if !defined(SGGetChannelTimeBase)
...
#if !defined(SGGetChannelDeviceAndInputNames)
...
SGChannel c;
short inInputNumber;
#if !defined(SGSetChannelDeviceInput)
...
SGChannel c;
UInt32 inFlags;
#if !defined(SGSetChannelSettingsStateChanging)
...
SeqGrabComponent s;
Boolean ok;
#if !defined(SGPanelValidateInput)
...
Handle ditl;
Point requestedSize;
#if !defined(SGPanelGetDITLForSize)
...
SGChannel c;
Rect r;
#if !defined(SGGetSrcVideoBounds)
...
#if !defined(SGGetVideoCompressorType)
...
SGChannel c;
OSType compressorType;
#if !defined(SGSetVideoCompressorType)
...
CodecQ temporalQuality;
long keyFrameRate;
#if !defined(SGSetVideoCompressor)
...
CodecQ temporalQuality;
long keyFrameRate;
#if !defined(SGGetVideoCompressor)
...
ComponentInstance _rv;
SGChannel c;
#if !defined(SGGetVideoDigitizerComponent)
...
#if !defined(SGSetVideoDigitizerComponent)
...
ComponentResult _rv;
SGChannel c;
#if !defined(SGVideoDigitizerChanged)
...
short bufferNum;
Boolean done;
#if !defined(SGGrabFrameComplete)
...
short depth;
Rect compressSize;
#if !defined(SGSetCompressBuffer)
...
short depth;
Rect compressSize;
#if !defined(SGGetCompressBuffer)
...
#if !defined(SGSetUseScreenBuffer)
...
SGChannel c;
Boolean useScreenBuffer;
#if !defined(SGGetUseScreenBuffer)
...
SGChannel c;
long preferredPacketSizeInBytes;
#if !defined(SGSetPreferredPacketSize)
...
SGChannel c;
long preferredPacketSizeInBytes;
#if !defined(SGGetPreferredPacketSize)
...
#if !defined(SGSetUserVideoCompressorList)
...
SGChannel c;
Handle compressorTypes;
#if !defined(SGGetUserVideoCompressorList)
...
SGChannel c;
Str255 driverName;
#if !defined(SGSetSoundInputDriver)
...
long _rv;
SGChannel c;
#if !defined(SGGetSoundInputDriver)
...
ComponentResult _rv;
SGChannel c;
#if !defined(SGSoundInputDriverChanged)
...
SGChannel c;
long seconds;
#if !defined(SGSetSoundRecordChunkSize)
...
long _rv;
SGChannel c;
#if !defined(SGGetSoundRecordChunkSize)
...
SGChannel c;
Fixed rate;
#if !defined(SGSetSoundInputRate)
...
Fixed _rv;
SGChannel c;
#if !defined(SGGetSoundInputRate)
...
short numChannels;
OSType compressionType;
#if !defined(SGSetSoundInputParameters)
...
short numChannels;
OSType compressionType;
#if !defined(SGGetSoundInputParameters)
...
SGChannel c;
Handle rates;
#if !defined(SGSetAdditionalSoundRates)
...
SGChannel c;
Handle rates;
#if !defined(SGGetAdditionalSoundRates)
...
SGChannel c;
short rettospace;
#if !defined(SGGetTextReturnToSpaceValue)
...
SGChannel c;
short rettospace;
#if !defined(SGSetTextReturnToSpaceValue)
...
Str255 str;
#if !defined(QTVideoOutputGetCurrentClientName)
...
QTVideoOutputComponent vo;
Str255 str;
#if !defined(QTVideoOutputSetClientName)
...
QTVideoOutputComponent vo;
Str255 str;
#if !defined(QTVideoOutputGetClientName)
...
QTVideoOutputComponent vo;
long displayModeID;
#if !defined(QTVideoOutputSetDisplayMode)
...
QTVideoOutputComponent vo;
long displayModeID;
#if !defined(QTVideoOutputGetDisplayMode)
...
QTVideoOutputComponent vo;
GWorldPtr gw;
#if !defined(QTVideoOutputGetGWorld)
...
#if !defined(QTVideoOutputGetIndSoundOutput)
...
#if !defined(QTVideoOutputGetClock)
...
QTVideoOutputComponent vo;
CGrafPtr echoPort;
#if !defined(QTVideoOutputSetEchoPort)
...
long index;
Component codec;
#if !defined(QTVideoOutputGetIndImageDecompressor)
...
QTVideoOutputComponent vo;
CGrafPtr echoPort;
#if !defined(QTVideoOutputBaseSetEchoPort)
...
UInt32 flags;
UInt32 flagsMask;
#if !defined(MediaSetChunkManagementFlags)
...
MediaHandler mh;
UInt32 flags;
#if !defined(MediaGetChunkManagementFlags)
...
MediaHandler mh;
Size allowance;
#if !defined(MediaSetPurgeableChunkMemoryAllowance)
...
MediaHandler mh;
Size allowance;
#if !defined(MediaGetPurgeableChunkMemoryAllowance)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(MediaEmptyAllPurgeableChunks)
...
long flags;
long flagsMask;
#if !defined(MediaSetHandlerCapabilities)
...
#if !defined(MediaSetMediaTimeScale)
...
MediaHandler mh;
TimeScale newTimeScale;
#if !defined(MediaSetMovieTimeScale)
...
#if !defined(MediaGetTrackOpaque)
...
long mode;
RGBColor opColor;
#if !defined(MediaSetGraphicsMode)
...
long mode;
RGBColor opColor;
#if !defined(MediaGetGraphicsMode)
...
MediaHandler mh;
short balance;
#if !defined(MediaSetSoundBalance)
...
MediaHandler mh;
short balance;
#if !defined(MediaGetSoundBalance)
...
MediaHandler mh;
TimeValue when;
#if !defined(MediaGetNextBoundsChange)
...
MediaHandler mh;
long index;
#if !defined(MediaSampleDescriptionChanged)
...
Boolean hasIt;
#if !defined(MediaHasCharacteristic)
...
short depth;
CTabHandle ctab;
#if !defined(MediaGetOffscreenBufferSize)
...
#if !defined(MediaGSetActiveSegment)
...
MediaHandler mh;
RgnHandle invalRgn;
#if !defined(MediaInvalidateRegion)
...
Fixed rate;
#if !defined(MediaGetNextStepTime)
...
MediaHandler mh;
long inputIndex;
#if !defined(MediaChangedNonPrimarySource)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(MediaTrackReferencesChanged)
...
MediaHandler mh;
long sampleNum;
#if !defined(MediaReleaseSampleDataPointer)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(MediaTrackPropertyAtomChanged)
...
MediaHandler mh;
Component outputComponent;
#if !defined(MediaSetSoundOutputComponent)
...
MediaHandler mh;
Component outputComponent;
#if !defined(MediaGetSoundOutputComponent)
...
MediaHandler mh;
Handle data;
#if !defined(MediaSetSoundLocalizationData)
...
MediaHandler mh;
RgnHandle rgn;
#if !defined(MediaGetInvalidRegion)
...
MediaHandler mh;
SampleDescriptionHandle sampleDescriptionH;
#if !defined(MediaSampleDescriptionB2N)
...
MediaHandler mh;
SampleDescriptionHandle sampleDescriptionH;
#if !defined(MediaSampleDescriptionN2B)
...
MediaHandler mh;
long inputIndex;
#if !defined(MediaFlushNonPrimarySourceData)
...
Point loc;
long targetRefCon;
#if !defined(MediaHitTestForTargetRefCon)
...
Point loc;
Boolean wasHit;
#if !defined(MediaHitTestTargetRefCon)
...
MediaHandler mh;
long targetRefCon;
#if !defined(MediaDisposeTargetRefCon)
...
long secondRefCon;
Boolean equal;
#if !defined(MediaTargetRefConsEqual)
...
MediaHandler mh;
void * refcon;
#if !defined(MediaPrePrerollCancel)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(MediaEnterEmptyEdit)
...
MediaHandler mh;
long milliSecs;
#if !defined(MediaCurrentMediaQueuedData)
...
MediaHandler mh;
short volume;
#if !defined(MediaGetEffectiveVolume)
...
MediaHandler mh;
Boolean enabled;
#if !defined(MediaGetSoundLevelMeteringEnabled)
...
MediaHandler mh;
Boolean enable;
#if !defined(MediaSetSoundLevelMeteringEnabled)
...
MediaHandler mh;
short balance;
#if !defined(MediaGetEffectiveSoundBalance)
...
Str255 errorString;
#if !defined(MediaGetErrorString)
...
MediaHandler mh;
UInt8 bandLevels;
#if !defined(MediaGetSoundEqualizerBandLevels)
...
short bass;
short treble;
#if !defined(MediaSetSoundBassAndTreble)
...
short bass;
short treble;
#if !defined(MediaGetSoundBassAndTreble)
...
ComponentResult _rv;
MediaHandler mh;
#if !defined(MediaTimeBaseChanged)
...
EventRecord e;
Boolean handledIt;
#if !defined(MediaMCIsPlayerEvent)
...
MediaHandler mh;
long mediaLoadState;
#if !defined(MediaGetMediaLoadState)
...
MediaHandler mh;
ComponentInstance vout;
#if !defined(MediaVideoOutputChanged)
...
long sampleNum;
long sampleCount;
#if !defined(MediaEmptySampleCache)
...
long propertyType;
void * propertyValue;
#if !defined(MediaRefConSetProperty)
...
long propertyType;
void * propertyValue;
#if !defined(MediaRefConGetProperty)
...
long navigation;
long refCon;
#if !defined(MediaNavigateTargetRefCon)
...
MediaHandler mh;
IdleManager pim;
#if !defined(MediaGGetIdleManager)
...
MediaHandler mh;
IdleManager im;
#if !defined(MediaGSetIdleManager)
...
#if !defined(MusicSetPartInstrumentNumber)
...
MusicComponent mc;
long part;
#if !defined(MusicGetPartInstrumentNumber)
...
long part;
long instrumentNumber;
#if !defined(MusicStorePartInstrument)
...
AtomicInstrument ai;
long flags;
#if !defined(MusicGetPartAtomicInstrument)
...
long flags;
#if !defined(MusicSetPartAtomicInstrument)
...
#if !defined(MusicSetPartController)
...
long part;
MusicController controllerNumber;
#if !defined(MusicGetPartController)
...
#if !defined(MusicGetInstrumentNames)
...
long id1;
long id2;
#if !defined(MusicGetDeviceConnection)
...
long id1;
long id2;
#if !defined(MusicUseDeviceConnection)
...
#if !defined(MusicGetKnobSettingStrings)
...
MusicComponent mc;
long newTimeStamp;
#if !defined(MusicSetOfflineTimeTo)
...
#if !defined(MusicGetInstrumentInfo)
...
long part;
long instrumentNumber;
#if !defined(MusicSetPartInstrumentNumberInterruptSafe)
...
long part;
Handle data;
#if !defined(MusicSetPartSoundLocalization)
...
long flags;
long baseResID;
#if !defined(MusicGenericConfigure)
...
#if !defined(MusicGenericGetKnobList)
...
MusicComponent mc;
Handle resourceIDH;
#if !defined(MusicGenericSetResourceNumbers)
...
#if !defined(MusicDerivedMIDISend)
...
ComponentResult _rv;
MusicComponent mc;
#if !defined(MusicDerivedOpenResFile)
...
MusicComponent mc;
short resRefNum;
#if !defined(MusicDerivedCloseResFile)
...
NoteAllocator na;
long index;
#if !defined(NAUnregisterMusicDevice)
...
ComponentResult _rv;
NoteAllocator na;
#if !defined(NASaveMusicConfiguration)
...
long transpose;
long velocityShift;
#if !defined(TuneSetPartTranspose)
...
NoteAllocator _rv;
TunePlayer tp;
#if !defined(TuneGetNoteAllocator)
...
TunePlayer tp;
Handle data;
#if !defined(TuneSetSoundLocalization)
...
unsigned long * header;
unsigned long size;
#if !defined(TuneSetHeaderWithSize)
