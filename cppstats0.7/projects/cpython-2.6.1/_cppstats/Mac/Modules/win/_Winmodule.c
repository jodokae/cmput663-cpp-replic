...
if (PyInt_Check(v)) {
*p_itself = (WindowPtr)PyInt_AsLong(v);
return 1;
}
{
DialogRef dlg;
...
OSStatus _err;
UInt32 outCount;
#if !defined(GetWindowOwnerCount)
...
PyObject *_res = NULL;
ItemCount _rv;
#if !defined(GetWindowRetainCount)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(ReshapeCustomWindow)
...
#if !defined(GetWindowWidgetHilite)
...
#if !defined(GetWindowAttributes)
...
#if !defined(ChangeWindowAttributes)
...
OSStatus _err;
RGBColor color;
#if !defined(SetWindowContentColor)
...
OSStatus _err;
RGBColor color;
#if !defined(GetWindowContentColor)
...
#if !defined(GetWindowContentPattern)
...
OSStatus _err;
PixPatHandle pixPat;
#if !defined(SetWindowContentPattern)
...
#if !defined(GetNextWindowOfClass)
...
OSStatus _err;
CFStringRef inTitle;
#if !defined(SetWindowAlternateTitle)
...
#if !defined(CopyWindowAlternateTitle)
...
OSStatus _err;
Rect outRect;
#if !defined(GetWindowStructureWidths)
...
#if !defined(SetWindowTitleWithCFString)
...
#if !defined(CopyWindowTitleAsCFString)
...
OSStatus _err;
FSSpec inFile;
#if !defined(SetWindowProxyFSSpec)
...
OSStatus _err;
FSSpec outFile;
#if !defined(GetWindowProxyFSSpec)
...
OSStatus _err;
AliasHandle inAlias;
#if !defined(SetWindowProxyAlias)
...
OSStatus _err;
AliasHandle alias;
#if !defined(GetWindowProxyAlias)
...
OSType fileType;
SInt16 vRefNum;
#if !defined(SetWindowProxyCreatorAndType)
...
#if !defined(BeginWindowProxyDrag)
...
#if !defined(TrackWindowProxyFromExistingDrag)
...
OSStatus _err;
Point startPt;
#if !defined(TrackWindowProxyDrag)
...
Boolean _rv;
EventRecord event;
#if !defined(IsWindowPathSelectClick)
...
OSStatus _err;
Boolean hilited;
#if !defined(HiliteWindowFrameForDrag)
...
WindowTransitionAction inAction;
Rect inRect;
#if !defined(TransitionWindowAndParent)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsWindowCollapsable)
...
short hGlobal;
short vGlobal;
#if !defined(MoveWindowStructure)
...
#if !defined(IsWindowInStandardState)
...
OSStatus _err;
Rect outUserState;
#if !defined(GetWindowIdealUserState)
...
OSStatus _err;
Rect inUserState;
#if !defined(SetWindowIdealUserState)
...
#if !defined(GetWindowGreatestAreaDevice)
...
Rect inScreenRect;
Rect outStructure;
#if !defined(ConstrainWindowToScreen)
...
#if !defined(GetSheetWindowParent)
...
OSType propertyTag;
UInt32 attributes;
#if !defined(GetWindowPropertyAttributes)
...
#if !defined(ChangeWindowPropertyAttributes)
...
PyObject *_res = NULL;
CGrafPtr _rv;
#if !defined(GetWindowStructurePort)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(IsWindowUpdatePending)
...
PyObject *_res = NULL;
Rect rect;
#if !defined(GetWindowStandardState)
...
PyObject *_res = NULL;
Rect rect;
#if !defined(SetWindowStandardState)
...
PyObject *_res = NULL;
Rect bounds;
#if !defined(GetWindowPortBounds)
...
PyObject *_res = NULL;
RgnHandle r;
#if !defined(GetWindowContentRgn)
...
sizeof(WindowObject),
0,
(destructor) WinObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) WinObj_compare,
(reprfunc) WinObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) WinObj_hash,
0,
0,
...
SInt16 resID;
WindowPtr outWindow;
#if !defined(CreateWindowFromResource)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(ShowFloatingWindows)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(HideFloatingWindows)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(AreFloatingWindowsVisible)
...
PyObject *_res = NULL;
WindowPtr _rv;
#if !defined(FrontNonFloatingWindow)
...
WindowClass inWindowClass;
Boolean mustBeVisible;
#if !defined(GetFrontWindowOfClass)
...
MenuHandle outMenu;
#if !defined(CreateStandardWindowMenu)
...
#if !defined(GetAvailableWindowPositioningBounds)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(DisableScreenUpdates)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(EnableScreenUpdates)
