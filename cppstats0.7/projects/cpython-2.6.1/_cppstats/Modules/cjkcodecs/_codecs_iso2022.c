...
#define IS_ISO2022ESC(c2) ((c2) == '(' || (c2) == ')' || (c2) == '$' || (c2) == '.' || (c2) == '&')
...
int flags;
const struct iso2022_designation *designations;
};
CODEC_INIT(iso2022) {
...
#define ISO8859_7_DECODE(c, assi) if ((c) < 0xa0) (assi) = (c); else if ((c) < 0xc0 && (0x288f3bc9L & (1L << ((c)-0xa0)))) (assi) = (c); else if ((c) >= 0xb4 && (c) <= 0xfe && ((c) >= 0xd4 || (0xbffffd77L & (1L << ((c)-0xb4))))) (assi) = 0x02d0 + (c); else if ((c) == 0xa1) (assi) = 0x2018; else if ((c) == 0xa2) (assi) = 0x2019; else if ((c) == 0xaf) (assi) = 0x2015;
static Py_ssize_t
...
if (err != 0)
return err;
} else if (CONFIG_ISSET(USE_G2) && IN2 == 'N') {
REQUIRE_INBUF(3)
...
else if (data[0] == 0x21 && data[1] == 0x40)
return 0xff3c;
else TRYMAP_DEC(jisx0208, u, data[0], data[1]);
...
#define REGISTRY_KSX1001_G0 { CHARSET_KSX1001, 0, 2, ksx1001_init, ksx1001_decoder, ksx1001_encoder }
#define REGISTRY_KSX1001_G1 { CHARSET_KSX1001, 1, 2, ksx1001_init, ksx1001_decoder, ksx1001_encoder }
#define REGISTRY_JISX0201_R { CHARSET_JISX0201_R, 0, 1, NULL, jisx0201_r_decoder, jisx0201_r_encoder }
#define REGISTRY_JISX0201_K { CHARSET_JISX0201_K, 0, 1, NULL, jisx0201_k_decoder, jisx0201_k_encoder }
#define REGISTRY_JISX0208 { CHARSET_JISX0208, 0, 2, jisx0208_init, jisx0208_decoder, jisx0208_encoder }
#define REGISTRY_JISX0208_O { CHARSET_JISX0208_O, 0, 2, jisx0208_init, jisx0208_decoder, jisx0208_encoder }
#define REGISTRY_JISX0212 { CHARSET_JISX0212, 0, 2, jisx0212_init, jisx0212_decoder, jisx0212_encoder }
#define REGISTRY_JISX0213_2000_1 { CHARSET_JISX0213_2000_1, 0, 2, jisx0213_init, jisx0213_2000_1_decoder, jisx0213_2000_1_encoder }
#define REGISTRY_JISX0213_2000_1_PAIRONLY { CHARSET_JISX0213_2000_1, 0, 2, jisx0213_init, jisx0213_2000_1_decoder, jisx0213_2000_1_encoder_paironly }
#define REGISTRY_JISX0213_2000_2 { CHARSET_JISX0213_2, 0, 2, jisx0213_init, jisx0213_2000_2_decoder, jisx0213_2000_2_encoder }
#define REGISTRY_JISX0213_2004_1 { CHARSET_JISX0213_2004_1, 0, 2, jisx0213_init, jisx0213_2004_1_decoder, jisx0213_2004_1_encoder }
#define REGISTRY_JISX0213_2004_1_PAIRONLY { CHARSET_JISX0213_2004_1, 0, 2, jisx0213_init, jisx0213_2004_1_decoder, jisx0213_2004_1_encoder_paironly }
#define REGISTRY_JISX0213_2004_2 { CHARSET_JISX0213_2, 0, 2, jisx0213_init, jisx0213_2004_2_decoder, jisx0213_2004_2_encoder }
#define REGISTRY_GB2312 { CHARSET_GB2312, 0, 2, gb2312_init, gb2312_decoder, gb2312_encoder }
#define REGISTRY_CNS11643_1 { CHARSET_CNS11643_1, 1, 2, cns11643_init, cns11643_1_decoder, cns11643_1_encoder }
#define REGISTRY_CNS11643_2 { CHARSET_CNS11643_2, 2, 2, cns11643_init, cns11643_2_decoder, cns11643_2_encoder }
...
#define CONFIGDEF(var, attrs) static const struct iso2022_config iso2022_##var##_config = { attrs, iso2022_##var##_designations };
...
BEGIN_MAPPINGS_LIST
END_MAPPINGS_LIST
#define ISO2022_CODEC(variation) { "iso2022_" #variation, &iso2022_##variation##_config, iso2022_codec_init, _STATEFUL_METHODS(iso2022) },
BEGIN_CODECS_LIST
ISO2022_CODEC(kr)
ISO2022_CODEC(jp)
ISO2022_CODEC(jp_1)
