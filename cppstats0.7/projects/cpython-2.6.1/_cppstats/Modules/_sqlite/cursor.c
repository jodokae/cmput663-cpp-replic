...
Py_INCREF(Py_None);
PyTuple_SetItem(descriptor, 2, Py_None);
Py_INCREF(Py_None);
PyTuple_SetItem(descriptor, 3, Py_None);
Py_INCREF(Py_None);
PyTuple_SetItem(descriptor, 4, Py_None);
Py_INCREF(Py_None);
PyTuple_SetItem(descriptor, 5, Py_None);
Py_INCREF(Py_None);
PyTuple_SetItem(descriptor, 6, Py_None);
...
0,
0,
Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_ITER|Py_TPFLAGS_BASETYPE,
cursor_doc,
0,
0,
0,
0,
(getiterfunc)pysqlite_cursor_getiter,
(iternextfunc)pysqlite_cursor_iternext,
cursor_methods,
cursor_members,
0,
0,
