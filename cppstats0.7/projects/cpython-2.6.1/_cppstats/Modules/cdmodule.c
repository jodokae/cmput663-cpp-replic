...
0,
"cd.cdplayer",
sizeof(cdplayerobject),
0,
(destructor)cdplayer_dealloc,
0,
(getattrfunc)cdplayer_getattr,
0,
0,
0,
};
...
0,
"cd.cdparser",
sizeof(cdparserobject),
0,
(destructor)cdparser_dealloc,
0,
(getattrfunc)cdparser_getattr,
0,
0,
0,
};
