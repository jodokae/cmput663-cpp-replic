...
#define WIN32_FUNCTION(func) {#func, (PyCFunction)win32_ ##func, METH_VARARGS | METH_STATIC, ""}
#define WIN32_CONSTANT(fmt, con) PyDict_SetItemString(Win32Type.tp_dict, #con, Py_BuildValue(fmt, con))
static PyObject *
