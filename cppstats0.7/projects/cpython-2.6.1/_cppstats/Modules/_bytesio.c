...
#define CHECK_CLOSED(self) if ((self)->buf == NULL) { PyErr_SetString(PyExc_ValueError, "I/O operation on closed file."); return NULL; }
static Py_ssize_t
...
"_bytesio._BytesIO",
sizeof(BytesIOObject),
0,
(destructor)bytesio_dealloc,
0,
0,
0,
0,
