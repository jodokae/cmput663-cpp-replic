...
#define check_bsddbobject_open(v, r) if ((v)->di_bsddb == NULL) { PyErr_SetString(BsddbError, "BSDDB object has already been closed"); return r; }
...
(lenfunc)bsddb_length,
(binaryfunc)bsddb_subscript,
(objobjargproc)bsddb_ass_sub,
};
static PyObject *
...
sizeof(bsddbobject),
0,
(destructor)bsddb_dealloc,
0,
(getattrfunc)bsddb_getattr,
0,
0,
0,
0,
