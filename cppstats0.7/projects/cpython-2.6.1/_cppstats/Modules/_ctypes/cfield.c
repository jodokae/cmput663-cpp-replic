...
(traverseproc)CField_traverse,
(inquiry)CField_clear,
0,
0,
0,
0,
...
0,
0,
(descrgetfunc)CField_get,
(descrsetfunc)CField_set,
0,
0,
0,
CField_new,
...
#endif
#define GET_BITFIELD(v, size) if (NUM_BITS(size)) { v <<= (sizeof(v)*8 - LOW_BIT(size) - NUM_BITS(size)); v >>= (sizeof(v)*8 - NUM_BITS(size)); }
#define SET(x, v, size) (NUM_BITS(size) ? ( ( x & ~(BIT_MASK(size) << LOW_BIT(size)) ) | ( (v & BIT_MASK(size)) << LOW_BIT(size) ) ) : v)
#define SWAP_2(v) ( ( (v >> 8) & 0x00FF) | ( (v << 8) & 0xFF00) )
#define SWAP_4(v) ( ( (v & 0x000000FF) << 24 ) | ( (v & 0x0000FF00) << 8 ) | ( (v & 0x00FF0000) >> 8 ) | ( ((v >> 24) & 0xFF)) )
#if defined(_MSC_VER)
#define SWAP_8(v) ( ( (v & 0x00000000000000FFL) << 56 ) | ( (v & 0x000000000000FF00L) << 40 ) | ( (v & 0x0000000000FF0000L) << 24 ) | ( (v & 0x00000000FF000000L) << 8 ) | ( (v & 0x000000FF00000000L) >> 8 ) | ( (v & 0x0000FF0000000000L) >> 24 ) | ( (v & 0x00FF000000000000L) >> 40 ) | ( ((v >> 56) & 0xFF)) )
#else
#define SWAP_8(v) ( ( (v & 0x00000000000000FFLL) << 56 ) | ( (v & 0x000000000000FF00LL) << 40 ) | ( (v & 0x0000000000FF0000LL) << 24 ) | ( (v & 0x00000000FF000000LL) << 8 ) | ( (v & 0x000000FF00000000LL) >> 8 ) | ( (v & 0x0000FF0000000000LL) >> 24 ) | ( (v & 0x00FF000000000000LL) >> 40 ) | ( ((v >> 56) & 0xFF)) )
#endif
...
#endif
#if SIZEOF__BOOL == 1
{ '?', bool_set, bool_get, &ffi_type_uchar},
