...
#define CheckCompressor(self) if ((self)->ob_compressorHdl == NULL) { PyErr_SetString(PyExc_RuntimeError, "(de)compressor not active"); return NULL; }
static PyObject *
...
{"close", clm_CloseCompressor, METH_NOARGS},
...
{"close", clm_CloseDecompressor, METH_NOARGS},
...
#define func(name, handler) static PyObject *cl_##name(PyObject *self, PyObject *args) { int x; if (!PyArg_ParseTuple(args, "i", &x)) return NULL; return Py##handler(CL_##name(x)); }
#define func2(name, handler) static PyObject *cl_##name(PyObject *self, PyObject *args) { int a1, a2; if (!PyArg_ParseTuple(args, "ii", &a1, &a2)) return NULL; return Py##handler(CL_##name(a1, a2)); }
...
#if defined(CL_ADDED_ALGORITHM_ERROR)
...
Py_DECREF(x);
#endif
#if defined(CL_MPEG1_VIDEO_MAX_MOTION_VECTOR_LENGTH_B_Y)
...
Py_DECREF(x);
#endif
#if defined(CL_MPEG1_VIDEO_MAX_MOTION_VECTOR_LENGTH_P_X)
...
Py_DECREF(x);
#endif
#if defined(CL_MPEG1_VIDEO_MAX_MOTION_VECTOR_LENGTH_P_Y)
