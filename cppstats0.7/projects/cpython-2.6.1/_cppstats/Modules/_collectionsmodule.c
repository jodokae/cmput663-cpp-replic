...
#define TRIM(d, popfunction) if (d->maxlen != -1 && d->len > d->maxlen) { PyObject *rv = popfunction(d, NULL); assert(rv != NULL && d->len <= d->maxlen); Py_DECREF(rv); }
