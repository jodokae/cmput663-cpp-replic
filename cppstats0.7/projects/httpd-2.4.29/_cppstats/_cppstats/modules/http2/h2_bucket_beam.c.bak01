...
#define H2_PROXY_BLIST_INSERT_HEAD(b, e) do { h2_beam_proxy *ap__b = (e); APR_RING_INSERT_HEAD(&(b)->list, ap__b, h2_beam_proxy, link); } while (0)
#define H2_BPROXY_LIST_INSERT_TAIL(b, e) do { h2_beam_proxy *ap__b = (e); APR_RING_INSERT_TAIL(&(b)->list, ap__b, h2_beam_proxy, link); } while (0)
#define H2_BPROXY_LIST_CONCAT(a, b) do { APR_RING_CONCAT(&(a)->list, &(b)->list, h2_beam_proxy, link); } while (0)
#define H2_BPROXY_LIST_PREPEND(a, b) do { APR_RING_PREPEND(&(a)->list, &(b)->list, h2_beam_proxy, link); } while (0)
