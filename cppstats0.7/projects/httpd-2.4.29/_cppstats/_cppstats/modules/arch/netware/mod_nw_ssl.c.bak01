...
#include <unilib.h>
#if !defined(SO_TLS_UNCLEAN_SHUTDOWN)
...
#define MKTIMESTR(format, tmfield) apr_time_exp_lt(&tm, apr_time_now()); result = apr_psprintf(p, format, tm.tmfield); resdup = FALSE;
