...
#define H2_REQ_ENTRIES_INSERT_HEAD(b, e) do { h2_ngn_entry *ap__b = (e); APR_RING_INSERT_HEAD((b), ap__b, h2_ngn_entry, link); } while (0)
#define H2_REQ_ENTRIES_INSERT_TAIL(b, e) do { h2_ngn_entry *ap__b = (e); APR_RING_INSERT_TAIL((b), ap__b, h2_ngn_entry, link); } while (0)
