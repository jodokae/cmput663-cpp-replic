...
#define U8TO64_LE(p) (((apr_uint64_t)((p)[0]) ) | ((apr_uint64_t)((p)[1]) << 8) | ((apr_uint64_t)((p)[2]) << 16) | ((apr_uint64_t)((p)[3]) << 24) | ((apr_uint64_t)((p)[4]) << 32) | ((apr_uint64_t)((p)[5]) << 40) | ((apr_uint64_t)((p)[6]) << 48) | ((apr_uint64_t)((p)[7]) << 56))
#define U64TO8_LE(p, v) do { (p)[0] = (unsigned char)((v) ); (p)[1] = (unsigned char)((v) >> 8); (p)[2] = (unsigned char)((v) >> 16); (p)[3] = (unsigned char)((v) >> 24); (p)[4] = (unsigned char)((v) >> 32); (p)[5] = (unsigned char)((v) >> 40); (p)[6] = (unsigned char)((v) >> 48); (p)[7] = (unsigned char)((v) >> 56); } while (0)
#define SIPROUND() do { v0 += v1; v1=ROTL64(v1,13); v1 ^= v0; v0=ROTL64(v0,32); v2 += v3; v3=ROTL64(v3,16); v3 ^= v2; v0 += v3; v3=ROTL64(v3,21); v3 ^= v0; v2 += v1; v1=ROTL64(v1,17); v1 ^= v2; v2=ROTL64(v2,32); } while(0)
...
switch (rem) {
case 7:
m |= (apr_uint64_t)ptr[6] << 48;
case 6:
m |= (apr_uint64_t)ptr[5] << 40;
case 5:
m |= (apr_uint64_t)ptr[4] << 32;
case 4:
m |= (apr_uint64_t)ptr[3] << 24;
case 3:
m |= (apr_uint64_t)ptr[2] << 16;
case 2:
m |= (apr_uint64_t)ptr[1] << 8;
case 1:
m |= (apr_uint64_t)ptr[0];
case 0:
break;
}
v3 ^= m;
...
#if defined(APU_CRYPTO_RECOMMENDED_DRIVER)
...
create_session_crypto_dir_config,
merge_session_crypto_dir_config,
create_session_crypto_config,
NULL,
session_crypto_cmds,
register_hooks
};
