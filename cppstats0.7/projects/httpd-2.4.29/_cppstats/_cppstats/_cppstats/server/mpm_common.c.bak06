...
ap_graceful_shutdown_timeout = 0;
ap_max_mem_free = ALLOCATOR_MAX_FREE_DEFAULT;
ap_thread_stacksize = 0;
}
#if !defined(INTERVAL_OF_WRITABLE_PROBES)
...
int gen = ap_config_generation - 1;
mpm_gen_info_t *cur;
if (geninfo == NULL) {
return APR_SUCCESS;
}
