...
PyObject *_res = NULL;
StScrpHandle _rv;
#if !defined(TEGetStyleScrapHandle)
...
sizeof(TEObject),
0,
(destructor) TEObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) TEObj_compare,
(reprfunc) TEObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
