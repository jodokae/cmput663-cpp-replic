...
0,
"_Snd.SndChannel",
sizeof(SndChannelObject),
0,
(destructor) SndCh_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) SndCh_compare,
(reprfunc) SndCh_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
...
sizeof(SPBObject),
0,
(destructor) SPBObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) SPBObj_compare,
(reprfunc) SPBObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) SPBObj_hash,
0,
0,
PyObject_GenericGetAttr,
PyObject_GenericSetAttr,
...
long A5 = SetA5(p->ob_A5);
p->ob_thiscallback = p->ob_completion;
