...
sizeof(GWorldObject),
0,
(destructor) GWorldObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) GWorldObj_compare,
(reprfunc) GWorldObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) GWorldObj_hash,
0,
0,
...
PyObject *_res = NULL;
PixMapHandle offscreenPixMap;
#if !defined(DisposeScreenBuffer)
...
GDHandle gdh;
PixMapHandle offscreenPixMap;
#if !defined(NewTempScreenBuffer)
