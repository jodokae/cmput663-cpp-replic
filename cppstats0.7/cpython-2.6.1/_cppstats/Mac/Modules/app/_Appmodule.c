...
#if !defined(SetThemeDrawingState)
...
PyObject *_res = NULL;
OSStatus _rv;
#if !defined(DisposeThemeDrawingState)
...
sizeof(ThemeDrawingStateObject),
0,
(destructor) ThemeDrawingStateObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) ThemeDrawingStateObj_compare,
(reprfunc) ThemeDrawingStateObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) ThemeDrawingStateObj_hash,
0,
0,
...
0,
ThemeDrawingStateObj_getsetlist,
0,
0,
0,
0,
0,
ThemeDrawingStateObj_tp_init,
ThemeDrawingStateObj_tp_alloc,
ThemeDrawingStateObj_tp_new,
ThemeDrawingStateObj_tp_free,
};
static PyObject *App_RegisterAppearanceClient(PyObject *_self, PyObject *_args) {
PyObject *_res = NULL;
OSStatus _err;
#if !defined(RegisterAppearanceClient)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(UnregisterAppearanceClient)
...
ThemeBrush inBrush;
Boolean inUpdate;
#if !defined(SetThemeWindowBackground)
...
#if !defined(DrawThemeWindowHeader)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemeWindowListViewHeader)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemeEditTextFrame)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemeListBoxFrame)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemePrimaryGroup)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemeSecondaryGroup)
...
Rect inRect;
ThemeDrawState inState;
#if !defined(DrawThemeModelessDialogFrame)
...
#if !defined(DrawThemeGenericWell)
...
OSStatus _err;
Boolean inHasFocus;
#if !defined(DrawThemeFocusRegion)
...
#if !defined(GetThemeAccentColors)
...
UInt32 inAttributes;
#if !defined(DrawThemeMenuBarBackground)
...
OSStatus _err;
SInt16 outHeight;
#if !defined(GetThemeMenuBarHeight)
...
#if !defined(DrawThemeMenuBackground)
...
#if !defined(GetThemeMenuBackgroundRegion)
...
OSStatus _err;
Rect inItemRect;
#if !defined(DrawThemeMenuSeparator)
...
OSStatus _err;
SInt16 outHeight;
#if !defined(GetThemeMenuSeparatorHeight)
...
SInt16 outHeight;
SInt16 outWidth;
#if !defined(GetThemeMenuItemExtra)
...
#if !defined(GetThemeMenuTitleExtra)
...
#if !defined(SetAnimatedThemeCursor)
...
#if !defined(GetThemeScrollBarThumbStyle)
...
#if !defined(GetThemeScrollBarArrowStyle)
...
#if !defined(GetThemeCheckBoxStyle)
...
Point ioBounds;
SInt16 outBaseline;
#if !defined(GetThemeTextDimensions)
...
ThemeDrawState inState;
Rect outOutset;
#if !defined(GetThemeTextShadowOutset)
...
Boolean isHoriz;
Rect trackBounds;
#if !defined(DrawThemeScrollBarArrows)
...
Boolean isHoriz;
Rect trackBounds;
#if !defined(GetThemeScrollBarTrackRect)
...
#if !defined(HitTestThemeScrollBarArrows)
...
#if !defined(DrawThemeScrollBarDelimiters)
...
UInt16 inKind;
ThemeButtonDrawInfo inNewInfo;
#if !defined(GetThemeButtonRegion)
...
Rect outBounds;
#if !defined(GetThemeButtonContentBounds)
...
ThemeButtonDrawInfo inDrawInfo;
Rect outBounds;
#if !defined(GetThemeButtonBackgroundBounds)
...
#if !defined(BeginThemeDragSound)
...
ThemeDrawState state;
UInt32 eraseData;
#if !defined(DrawThemeChasingArrows)
...
ThemeDrawState state;
UInt32 eraseData;
#if !defined(DrawThemePopupArrow)
...
Boolean isSmall;
ThemeDrawState state;
#if !defined(DrawThemeStandaloneGrowBox)
...
Boolean isSmall;
ThemeDrawState state;
#if !defined(DrawThemeStandaloneNoGrowBox)
...
Boolean isSmall;
Rect bounds;
#if !defined(GetThemeStandaloneGrowBoxBounds)
...
PyObject *_res = NULL;
OSStatus _err;
#if !defined(NormalizeThemeDrawingState)
...
#if !defined(GetThemeDrawingState)
...
SInt16 inDepth;
Boolean inColorDev;
#if !defined(ApplyThemeBackground)
...
SInt16 depth;
Boolean isColorDev;
#if !defined(SetThemeTextColorForWindow)
...
Boolean _rv;
OSType fileType;
#if !defined(IsValidAppearanceFileType)
...
Boolean inColorDev;
RGBColor outColor;
#if !defined(GetThemeBrushAsColor)
