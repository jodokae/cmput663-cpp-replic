...
int dataPtr__in_len__;
UInt32 dataOffset;
#if !defined(SetDragItemFlavorData)
...
#if !defined(ChangeDragBehaviors)
...
UInt16 index;
ItemReference theItemRef;
#if !defined(GetDragItemReferenceNumber)
...
ItemReference theItemRef;
UInt16 numFlavors;
#if !defined(CountDragItemFlavors)
...
0,
"_Drag.DragObj",
sizeof(DragObjObject),
0,
(destructor) DragObj_dealloc,
0,
(getattrfunc)0,
(setattrfunc)0,
(cmpfunc) DragObj_compare,
(reprfunc) DragObj_repr,
(PyNumberMethods *)0,
(PySequenceMethods *)0,
(PyMappingMethods *)0,
(hashfunc) DragObj_hash,
0,
0,
