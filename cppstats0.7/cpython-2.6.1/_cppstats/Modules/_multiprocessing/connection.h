...
#define READABLE 1
#define WRITABLE 2
#define CHECK_READABLE(self) if (!(self->flags & READABLE)) { PyErr_SetString(PyExc_IOError, "connection is write-only"); return NULL; }
#define CHECK_WRITABLE(self) if (!(self->flags & WRITABLE)) { PyErr_SetString(PyExc_IOError, "connection is read-only"); return NULL; }
static PyObject *
...
"_multiprocessing." CONNECTION_NAME,
...
0,
0,
offsetof(ConnectionObject, weakreflist),
0,
0,
connection_methods,
0,
