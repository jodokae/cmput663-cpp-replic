...
#if defined(BZ_CONFIG_ERROR)
#if SIZEOF_LONG >= 8
#define BZS_TOTAL_OUT(bzs) (((long)bzs->total_out_hi32 << 32) + bzs->total_out_lo32)
#elif SIZEOF_LONG_LONG >= 8
#define BZS_TOTAL_OUT(bzs) (((PY_LONG_LONG)bzs->total_out_hi32 << 32) + bzs->total_out_lo32)
#else
#define BZS_TOTAL_OUT(bzs) bzs->total_out_lo32
#endif
#else
...
"bz2.BZ2File",
sizeof(BZ2FileObject),
0,
(destructor)BZ2File_dealloc,
0,
0,
0,
0,
...
0,
0,
(getiterfunc)BZ2File_getiter,
(iternextfunc)BZ2File_iternext,
BZ2File_methods,
BZ2File_members,
BZ2File_getset,
0,
...
PyVarObject_HEAD_INIT(NULL, 0)
"bz2.BZ2Compressor",
sizeof(BZ2CompObject),
0,
(destructor)BZ2Comp_dealloc,
0,
0,
0,
0,
