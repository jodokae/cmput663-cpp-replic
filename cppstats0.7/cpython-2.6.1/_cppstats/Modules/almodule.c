...
param->sizeIn = PyString_GET_SIZE(value)+1;
break;
case AL_SET_VAL:
case AL_VECTOR_VAL:
...
sizeof(alcobject),
0,
(destructor)alc_dealloc,
(printfunc)0,
(getattrfunc)alc_getattr,
(setattrfunc)0,
(cmpfunc)0,
(reprfunc)0,
0,
...
sizeof(alpobject),
0,
(destructor)alp_dealloc,
(printfunc)0,
(getattrfunc)alp_getattr,
(setattrfunc)0,
(cmpfunc)0,
(reprfunc)0,
0,
