...
"sunaudiodev.sun_audio_device",
sizeof(sadobject),
0,
(destructor)sad_dealloc,
0,
(getattrfunc)sad_getattr,
0,
0,
0,
};
static PyTypeObject Sadstatustype = {
PyVarObject_HEAD_INIT(&PyType_Type, 0)
"sunaudiodev.sun_audio_device_status",
sizeof(sadstatusobject),
0,
(destructor)sads_dealloc,
0,
(getattrfunc)sads_getattr,
(setattrfunc)sads_setattr,
0,
0,
};
static PyObject *
