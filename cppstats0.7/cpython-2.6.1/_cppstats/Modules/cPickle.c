...
#define PDATA_POP(D, V) { if ((D)->length) (V) = (D)->data[--((D)->length)]; else { PyErr_SetString(UnpicklingError, "bad pickle data"); (V) = NULL; } }
#define PDATA_PUSH(D, O, ER) { if (((Pdata*)(D))->length == ((Pdata*)(D))->size && Pdata_grow((Pdata*)(D)) < 0) { Py_DECREF(O); return ER; } ((Pdata*)(D))->data[((Pdata*)(D))->length++] = (O); }
#define PDATA_APPEND(D, O, ER) { if (((Pdata*)(D))->length == ((Pdata*)(D))->size && Pdata_grow((Pdata*)(D)) < 0) return ER; Py_INCREF(O); ((Pdata*)(D))->data[((Pdata*)(D))->length++] = (O); }
static PyObject *
...
#define ARG_TUP(self, o) { if (self->arg || (self->arg=PyTuple_New(1))) { Py_XDECREF(PyTuple_GET_ITEM(self->arg,0)); PyTuple_SET_ITEM(self->arg,0,o); } else { Py_DECREF(o); } }
#define FREE_ARG_TUP(self) { if (Py_REFCNT(self->arg) > 1) { Py_DECREF(self->arg); self->arg=NULL; } }
...
#if !defined(PY_CPICKLE_FAST_LIMIT)
...
0,
(getattrfunc)Unpickler_getattr,
(setattrfunc)Unpickler_setattr,
0,
0,
0,
0,
