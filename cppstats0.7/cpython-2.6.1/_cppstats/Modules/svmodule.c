...
0,
(destructor)capture_dealloc,
0,
(getattrfunc)capture_getattr,
0,
0,
0,
};
...
switch (j) {
case 0:
mapp[i].red = PyInt_AsLong(cell);
break;
case 1:
mapp[i].blue = PyInt_AsLong(cell);
break;
case 2:
mapp[i].green = PyInt_AsLong(cell);
break;
}
if (PyErr_Occurred())
goto finally;
...
sizeof(svobject),
0,
(destructor)svideo_dealloc,
0,
(getattrfunc)svideo_getattr,
0,
0,
0,
};
