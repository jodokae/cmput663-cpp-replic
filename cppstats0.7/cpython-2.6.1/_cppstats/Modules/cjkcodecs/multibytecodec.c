...
#define REQUIRE_ENCODEBUFFER(buf, s) { if ((s) < 1 || (buf)->outbuf + (s) > (buf)->outbuf_end) if (expand_encodebuffer(buf, s) == -1) goto errorexit; }
static int
...
#define REQUIRE_DECODEBUFFER(buf, s) { if ((s) < 1 || (buf)->outbuf + (s) > (buf)->outbuf_end) if (expand_decodebuffer(buf, s) == -1) goto errorexit; }
static int
...
"MultibyteCodec",
sizeof(MultibyteCodecObject),
0,
(destructor)multibytecodec_dealloc,
0,
0,
0,
0,
...
sizeof(MultibyteIncrementalEncoderObject),
0,
(destructor)mbiencoder_dealloc,
0,
0,
0,
0,
...
| Py_TPFLAGS_BASETYPE,
0,
(traverseproc)mbiencoder_traverse,
0,
0,
0,
0,
...
sizeof(MultibyteIncrementalDecoderObject),
0,
(destructor)mbidecoder_dealloc,
0,
0,
0,
0,
...
| Py_TPFLAGS_BASETYPE,
0,
(traverseproc)mbidecoder_traverse,
0,
0,
0,
0,
...
0,
(destructor)mbstreamreader_dealloc,
0,
0,
0,
0,
...
| Py_TPFLAGS_BASETYPE,
0,
(traverseproc)mbstreamreader_traverse,
0,
0,
0,
0,
...
sizeof(MultibyteStreamWriterObject),
0,
(destructor)mbstreamwriter_dealloc,
0,
0,
0,
0,
...
| Py_TPFLAGS_BASETYPE,
0,
(traverseproc)mbstreamwriter_traverse,
0,
0,
0,
0,
