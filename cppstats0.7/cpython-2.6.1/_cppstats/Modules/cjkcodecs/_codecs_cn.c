...
#undef hz
#endif
#define GBK_DECODE(dc1, dc2, assi) if ((dc1) == 0xa1 && (dc2) == 0xaa) (assi) = 0x2014; else if ((dc1) == 0xa8 && (dc2) == 0x44) (assi) = 0x2015; else if ((dc1) == 0xa1 && (dc2) == 0xa4) (assi) = 0x00b7; else TRYMAP_DEC(gb2312, assi, dc1 ^ 0x80, dc2 ^ 0x80); else TRYMAP_DEC(gbkext, assi, dc1, dc2);
#define GBK_ENCODE(code, assi) if ((code) == 0x2014) (assi) = 0xa1aa; else if ((code) == 0x2015) (assi) = 0xa844; else if ((code) == 0x00b7) (assi) = 0xa1a4; else if ((code) != 0x30fb && TRYMAP_ENC_COND(gbcommon, assi, code));
ENCODER(gb2312) {
while (inleft > 0) {
Py_UNICODE c = IN1;
DBCHAR code;
