...
0,
0,
(ssizeargfunc)BaseException_getitem,
(ssizessizeargfunc)BaseException_getslice,
0,
0,
0,
0,
...
#define PRE_INIT(TYPE) if (PyType_Ready(&_PyExc_ ##TYPE) < 0) Py_FatalError("exceptions bootstrapping error.");
#define POST_INIT(TYPE) Py_INCREF(PyExc_ ##TYPE); PyModule_AddObject(m, #TYPE, PyExc_ ##TYPE); if (PyDict_SetItemString(bdict, #TYPE, PyExc_ ##TYPE)) Py_FatalError("Module dictionary insertion problem.");
