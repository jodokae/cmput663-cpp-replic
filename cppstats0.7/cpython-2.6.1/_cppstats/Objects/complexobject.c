...
#define TO_COMPLEX(obj, c) if (PyComplex_Check(obj)) c = ((PyComplexObject *)(obj))->cval; else if (to_complex(&(obj), &(c)) < 0) return (obj)
static int
...
(binaryfunc)complex_classic_div,
