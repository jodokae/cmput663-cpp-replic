...
#define NEW_STYLE_NUMBER(o) PyType_HasFeature((o)->ob_type, Py_TPFLAGS_CHECKTYPES)
static PyObject *
...
#define BINARY_FUNC(func, op, op_name) PyObject * func(PyObject *v, PyObject *w) { return binary_op(v, w, NB_SLOT(op), op_name); }
...
#define INPLACE_BINOP(func, iop, op, op_name) PyObject * func(PyObject *v, PyObject *w) { return binary_iop(v, w, NB_SLOT(iop), NB_SLOT(op), op_name); }
