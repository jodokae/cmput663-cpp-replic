...
*/
#define _PyTZINFO_HEAD PyObject_HEAD long hashcode; char hastzinfo; /* boolean flag */
...
#define PyDateTime_IMPORT PyDateTimeAPI = (PyDateTime_CAPI*) PyCObject_ImportEx("datetime", "datetime_CAPI", DATETIME_API_MAGIC)
*/
