...
#define UNICODE_DEFAULT_ENCODING(arg) _PyUnicode_AsDefaultEncodedString(arg, NULL)
...
/* For #codes */
#define FETCH_SIZE int *q=NULL;Py_ssize_t *q2=NULL;if (flags & FLAG_SIZE_T) q2=va_arg(*p_va, Py_ssize_t*); else q=va_arg(*p_va, int*);
