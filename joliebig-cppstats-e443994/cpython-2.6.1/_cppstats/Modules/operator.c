...
#define spam1(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a1) { return AOP(a1); }
#define spam2(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; return AOP(a1,a2); }
#define spamoi(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1; int a2; if(! PyArg_ParseTuple(a,"Oi:" #OP,&a1,&a2)) return NULL; return AOP(a1,a2); }
#define spam2n(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; if(-1 == AOP(a1,a2)) return NULL; Py_INCREF(Py_None); return Py_None; }
#define spam3n(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2, *a3; if(! PyArg_UnpackTuple(a,#OP,3,3,&a1,&a2,&a3)) return NULL; if(-1 == AOP(a1,a2,a3)) return NULL; Py_INCREF(Py_None); return Py_None; }
#define spami(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a1) { long r; if(-1 == (r=AOP(a1))) return NULL; return PyBool_FromLong(r); }
#define spami2(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; long r; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; if(-1 == (r=AOP(a1,a2))) return NULL; return PyInt_FromLong(r); }
#define spamn2(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; Py_ssize_t r; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; if(-1 == (r=AOP(a1,a2))) return NULL; return PyInt_FromSsize_t(r); }
#define spami2b(OP,AOP) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; long r; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; if(-1 == (r=AOP(a1,a2))) return NULL; return PyBool_FromLong(r); }
#define spamrc(OP,A) static PyObject *OP(PyObject *s, PyObject *a) { PyObject *a1, *a2; if(! PyArg_UnpackTuple(a,#OP,2,2,&a1,&a2)) return NULL; return PyObject_RichCompare(a1,a2,A); }
...
#define spam2(OP,ALTOP,DOC) {#OP, op_##OP, METH_VARARGS, PyDoc_STR(DOC)}, {#ALTOP, op_##OP, METH_VARARGS, PyDoc_STR(DOC)},
#define spam1o(OP,DOC) {#OP, OP, METH_O, PyDoc_STR(DOC)},
#define spam2o(OP,ALTOP,DOC) {#OP, op_##OP, METH_O, PyDoc_STR(DOC)}, {#ALTOP, op_##OP, METH_O, PyDoc_STR(DOC)},
