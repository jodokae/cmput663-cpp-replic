...
#if defined(PY_LONG_LONG /* If no PY_LONG_LONG, don't compile anything! */)
...
#define ROR64(x, y) ( ((((x) & Py_ULL(0xFFFFFFFFFFFFFFFF))>>((unsigned PY_LONG_LONG)(y) & 63)) | ((x)<<((unsigned PY_LONG_LONG)(64-((y) & 63))))) & Py_ULL(0xFFFFFFFFFFFFFFFF))
