...
PyObject *_res = NULL;
UInt32 _rv;
#if !defined(GetCurrentKeyModifiers)
...
PyObject *_res = NULL;
Boolean _rv;
#if !defined(CheckEventQueueForUserCancel)
