...
#if !defined(IconRefToIconFamily)
...
#if !defined(IconFamilyToIconSuite)
...
IconSelectorValue whichIcons;
IconFamilyHandle iconFamily;
#if !defined(IconSuiteToIconFamily)
...
IconRef theIconRef;
#if !defined(GetIconRefFromFolder)
...
IconFamilyHandle iconFamily;
IconRef theIconRef;
#if !defined(RegisterIconRefFromIconFamily)
...
SInt16 resourceID;
IconRef theIconRef;
#if !defined(RegisterIconRefFromResource)
...
FSRef iconFile;
IconRef theIconRef;
#if !defined(RegisterIconRefFromFSRef)
...
FSSpec resourceFile;
SInt16 resourceID;
#if !defined(OverrideIconRefFromResource)
...
OSErr _err;
IconRef theIconRef;
#if !defined(RemoveIconRefOverride)
...
IconServicesUsageFlags iconServicesUsageFlags;
IconRef theIconRef;
#if !defined(GetIconSizesFromIconRef)
...
OSErr _err;
SInt16 vRefNum;
#if !defined(FlushIconRefsByVolume)
...
#if !defined(SetCustomIconsEnabled)
...
#if !defined(GetCustomIconsEnabled)
...
FSSpec iconFile;
IconRef theIconRef;
#if !defined(RegisterIconRefFromIconFile)
