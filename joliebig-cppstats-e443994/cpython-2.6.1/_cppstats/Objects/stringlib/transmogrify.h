...
#define _STRINGLIB_SPLIT_APPEND(data, left, right) str = STRINGLIB_NEW((data) + (left), (right) - (left)); if (str == NULL) goto onError; if (PyList_Append(list, str)) { Py_DECREF(str); goto onError; } else Py_DECREF(str);
